...
/-!
# Refactored MD 004: finite geometric structures

Source: `github-nick:nickgou-nuke/MD`, file `004.md`.

Chapter 4 discusses hyperkähler geometry of the Hermitian `2 × 2` matrix
coordinate space and Kähler/symplectic geometry of the ambient `M₂(ℂ)`.
This file extracts the finite algebraic skeleton.
-/
