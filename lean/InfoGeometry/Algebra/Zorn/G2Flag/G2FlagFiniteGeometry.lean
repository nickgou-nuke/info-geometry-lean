...
/- The 189 incident flags of the exported parabolic certificate.
    This owner records the finite incidence cardinality only; it does not yet
    identify the certificate with an automorphism quotient. -/
