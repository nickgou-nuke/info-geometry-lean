...
/--
Constructive route for the finite Souriau/KKT packet, removing redundant KKT
...
theorem structuredSouriauKKTTranslatorPacket_ofExactResiduals_of_det
   ...
   ∧ DimensionAgnosticKKTResiduals.exact.toShadow.complementarySlackness
   ∧ DimensionAgnosticKKTResiduals.exact.toShadow.finitePartitionAdmissible := by
   have hPSD := souriauFisherResponseMatrix_positiveSemidefinite_of_det_nonneg C.M C.T hdet
   exact structuredSouriauKKTTranslatorPacket_ofExactResiduals_det_nonneg C hdet eta xβ xμ
