...
theorem finite_primon_heat_mellin_zeta_KAN_bridge
  ...
  exact ⟨hMellin,
    InfoGeometry.Quantum.ZetaSpectralBridge.finitePrimonMellinTrace_eq_dirichlet n s,
    InfoGeometry.Quantum.ZetaSpectralBridge.finitePrimonMellin_log_generator_eq_KAN_logdet n⟩
