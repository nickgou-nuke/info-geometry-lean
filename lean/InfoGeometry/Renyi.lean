...
noncomputable def logRNDensity {α : Type*} [Fintype α]
(N_func : EmpiricalCounts α)
(Q : ProbabilityDist α)
(x : α) : ℝ :=
Real.log (densityRatio N_func Q x)

noncomputable def relativeSurprisal {α : Type*} [Fintype α]
(N_func : EmpiricalCounts α)
(Q : ProbabilityDist α)
(x : α) : ℝ :=
...
/-- Z(τ) = ∑ Q(x) * exp(-τ * ℓ(x)). -/
noncomputable def partitionFunction {α : Type*} [Fintype α]
(N_func : EmpiricalCounts α)
(Q : ProbabilityDist α)
(τ : ℝ) : ℝ :=
...
/-- Φ(τ) = log Z(τ). -/
noncomputable def Phi {α : Type*} [Fintype α]
(N_func : EmpiricalCounts α)
(Q : ProbabilityDist α)
(τ : ℝ) : ℝ :=
