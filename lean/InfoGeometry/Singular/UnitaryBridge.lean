...
/- The former bridge depended on removed Moore--Penrose/Drazin adapter
   namespaces and asserted physical correspondences not owned by the current
   Singular architecture.  Its native owners remain imported above. -/
