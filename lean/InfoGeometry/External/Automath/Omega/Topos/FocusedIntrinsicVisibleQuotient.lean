...
/-- Focused-publication wrapper for character-theoretic detection of the intrinsic visible
    quotient.
    thm:intrinsic-visible-quotient -/
theorem paper_conservative_extension_intrinsic_visible_quotient_focused
