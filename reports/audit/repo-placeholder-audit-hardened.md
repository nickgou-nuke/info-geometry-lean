...
Generated: `2026-05-11T19:17:32.947853+00:00`

- Modules scanned: **1354**
- Modules with findings: **476**
- Total findings: **1497** (hard=2, soft=1495)

## `InfoGeometry.Algebraic.ChiralOperatorAlgebra`
- path: `lean/InfoGeometry/Algebraic/ChiralOperatorAlgebra.lean`
- findings: 1 (hard=0, soft=1)
...
- L84: **SOFT** `vacuous-prop-constant` in `theorem mem_LMultiplesOfSet_iff`
...
- findings: 30 (hard=0, soft=30)

- L257: **SOFT** `vacuous-prop-constant` in `theorem PrimitiveFinset_iff`
  - theorem/lemma is closed by an uninformative constant
  - `255:   intro n hn`
- L263: **SOFT** `vacuous-prop-constant` in `theorem SupportedAboveFinset_iff`
  - theorem/lemma is closed by an uninformative constant
...
- L354: **SOFT** `vacuous-prop-constant` in `theorem primitiveModularKernel_eq_mellinKernel_shift`
  - theorem/lemma is closed by an uninformative constant
  - `352:   rw [log_primitiveInverseBase h]`
- L502: **SOFT** `vacuous-prop-constant` in `theorem primitiveWeight_mul_eq_of_right_one`
  - theorem/lemma is closed by an uninformative constant
...
- L635: **SOFT** `vacuous-prop-constant` in `theorem arithmeticCountWeight_eq_mul_kernel`
  - theorem/lemma is closed by an uninformative constant
  - `633:     primitiveWeightSum ({n} : Finset ℕ) = primitiveWeight n := by`
- L639: **SOFT** `vacuous-prop-constant` in `theorem arithmeticPartition_eq_sum`
  - theorem/lemma is closed by an uninformative constant
  - `637:     arithmeticCountWeight counts s n = counts n * primitiveMellinKernel n s := by`
- L643: **SOFT** `vacuous-prop-constant` in `theorem arithmeticTotalMass_eq_sum`
  - theorem/lemma is closed by an uninformative constant
  - `641:     arithmeticPartition A counts s = Finset.sum A (fun n => counts n * primitiveMellinKernel n s) := by`
- L647: **SOFT** `vacuous-prop-constant` in `theorem arithmeticBaseShape_eq_div`
  - theorem/lemma is closed by an uninformative constant
  - `645:     arithmeticTotalMass A counts = Finset.sum A counts := by`
- L848: **SOFT** `vacuous-prop-constant` in `theorem arithmeticShapeMellin_eq_sum`
  - theorem/lemma is closed by an uninformative constant
  - `846: `
...
- L865: **SOFT** `vacuous-prop-constant` in `theorem arithmeticPrimePartition_eq_sum`
  - theorem/lemma is closed by an uninformative constant
...
- L1002: **SOFT** `skeletal-proof` in `theorem primitiveFinset_empty`
  - proof appears to be tactic-automation-only or skeletal
  - `1000:   intro a ha`
- L1209: **SOFT** `vacuous-prop-constant` in `theorem primitiveDivisorFiber_eq_filter`
  - theorem/lemma is closed by an uninformative constant
  - `1207:     refine ⟨d, Finset.mem_filter.mpr ⟨hdA, dvd_rfl⟩, ?_⟩`
- L1213: **SOFT** `vacuous-prop-constant` in `theorem primitiveDivisorQuotient_eq_image_fiber`
  - theorem/lemma is closed by an uninformative constant
...
- findings: 6 (hard=0, soft=6)

- L38: **SOFT** `vacuous-prop-constant` in `theorem projectiveWeylThermalMass_eq`
  - theorem/lemma is closed by an uninformative constant
  - `36:     (counts : CountProfile) (support : Finset ℕ) (u : ℝ) : CountProfile :=`
- L45: **SOFT** `vacuous-prop-constant` in `theorem projectiveArithmeticShape_eq`
  - theorem/lemma is closed by an uninformative constant
...
- L219: **SOFT** `vacuous-prop-constant` in `theorem mem_automorphicResonanceSet_iff`
  - theorem/lemma is closed by an uninformative constant
  - `217: `
...
- L63: **SOFT** `vacuous-prop-constant` in `theorem informationBerryPhase_eq_loopLength_mul_chiralAnomalyIndex`
  - theorem/lemma is closed by an uninformative constant
...
- L37: **SOFT** `vacuous-prop-constant` in `theorem bogoliubovFrameAction_eq_conjugate`
  - theorem/lemma is closed by an uninformative constant
  - `35: variable {E : Type*}`
...
- L100: **SOFT** `vacuous-prop-constant` in `theorem generatorCartanDecomposition_iff`
  - theorem/lemma is closed by an uninformative constant
...
- findings: 9 (hard=0, soft=9)

- L141: **SOFT** `vacuous-prop-constant` in `theorem obstructionScale_eq_projectorObstruction_nnnorm`
  - theorem/lemma is closed by an uninformative constant
  - `139:           - CI.metricChiralProjector * CI.spectralChiralProjector‖₊ := by`
- L146: **SOFT** `vacuous-prop-constant` in `theorem projectorObstruction_nnnorm_eq_obstructionScale`
  - theorem/lemma is closed by an uninformative constant
  - `144:     CI.obstructionScale = ‖CI.projectorObstruction‖₊ := by`
- L151: **SOFT** `vacuous-prop-constant` in `theorem chiralScale_eq_obstructionScale`
  - theorem/lemma is closed by an uninformative constant
  - `149:     ‖CI.projectorObstruction‖₊ = CI.obstructionScale := by`
- L156: **SOFT** `vacuous-prop-constant` in `theorem epsilon_eq_obstructionScale`
  - theorem/lemma is closed by an uninformative constant
...
- L69: **SOFT** `vacuous-prop-constant` in `theorem GammaS_eq_two_mul_spectralProjector_sub_one`
  - theorem/lemma is closed by an uninformative constant
...
- L110: **SOFT** `vacuous-prop-constant` in `theorem bridge_totalMass_preserved`
  - theorem/lemma is closed by an uninformative constant
...
- L110: **SOFT** `placeholder-naming` in `theorem bridge_totalMass_preserved`
  - declaration name is marked as placeholder/bridge/hypothesis surface
  - `108:     (canonicalCliffordState P).1 + (canonicalCliffordState P).2 = 1 := by`
- L118: **SOFT** `vacuous-prop-constant` in `theorem bridge_modeEntropy_preserved`
  - theorem/lemma is closed by an uninformative constant
...
- L118: **SOFT** `placeholder-naming` in `theorem bridge_modeEntropy_preserved`
  - declaration name is marked as placeholder/bridge/hypothesis surface
  - `116:     cliffordTotalMass (toCliffordPresentation P) = permutationTotalMass P := by`
- L126: **SOFT** `vacuous-prop-constant` in `theorem bridge_parityEntropy_preserved`
  - theorem/lemma is closed by an uninformative constant
...
- L126: **SOFT** `placeholder-naming` in `theorem bridge_parityEntropy_preserved`
  - declaration name is marked as placeholder/bridge/hypothesis surface
  - `124:     cliffordModeEntropy (toCliffordPresentation P) = permutationModeEntropy P := by`
- L134: **SOFT** `vacuous-prop-constant` in `theorem bridge_semanticState_eq_canonical`
  - theorem/lemma is closed by an uninformative constant
...
- L107: **SOFT** `vacuous-prop-constant` in `theorem boundaryGenerator_eq_projector_commutator`
  - theorem/lemma is closed by an uninformative constant
  - `105: abbrev dilationOperator : E →L[ℝ] E :=`
- L113: **SOFT** `vacuous-prop-constant` in `theorem rightBoundaryGenerator_eq_projector_commutator`
  - theorem/lemma is closed by an uninformative constant
...
- L150: **SOFT** `vacuous-prop-constant` in `theorem projected_supercharge_eq_sub_chiral`
  - theorem/lemma is closed by an uninformative constant
...
- L155: **SOFT** `vacuous-prop-constant` in `theorem projected_left_eq_commutator_PD_PL`
  - theorem/lemma is closed by an uninformative constant
  - `153:     QD U = QR U - QL U := by`
- L161: **SOFT** `vacuous-prop-constant` in `theorem projected_right_eq_commutator_PD_PR`
  - theorem/lemma is closed by an uninformative constant
...
- L99: **SOFT** `vacuous-prop-constant` in `theorem current_eq_density_smul_velocityFrame`
  - theorem/lemma is closed by an uninformative constant
  - `97: def spinAxis (ψ : DiracHestenesSpinor A) : A :=`
- L168: **SOFT** `vacuous-prop-constant` in `theorem polar_current_eq_density_velocity`
  - theorem/lemma is closed by an uninformative constant
  - `166: def phasePlane_of_polar (P : DiracHestenesPolarDecomposition A) : A :=`
- L173: **SOFT** `vacuous-prop-constant` in `theorem polar_spinPlane_eq_density_spinPlane`
  - theorem/lemma is closed by an uninformative constant
  - `171:     P.current_of_polar = P.densityScale P.density P.velocityFrameReadout := by`
- L178: **SOFT** `vacuous-prop-constant` in `theorem yvonTakabayasiAngle_of_polar_eq`
  - theorem/lemma is closed by an uninformative constant
  - `176:     P.spinPlane_of_polar = P.densityScale P.density P.orientedSpinPlane := by`
- L532: **SOFT** `vacuous-prop-constant` in `theorem concrete_det_realification_eq_interval_sq`
  - theorem/lemma is closed by an uninformative constant
  - `530:     MinkowskiCoordinates.interval, RealMatrix4.matMul]`
- L593: **SOFT** `vacuous-prop-constant` in `theorem concreteMajoranaBdG_det_eq_pfaffian_sq`
  - theorem/lemma is closed by an uninformative constant
...
- L41: **SOFT** `vacuous-prop-constant` in `theorem sl2z_neg_smul`
  - theorem/lemma is closed by an uninformative constant
  - `39:     simp`
...
- L66: **SOFT** `vacuous-prop-constant` in `theorem realToMathlibUHP_im`
  - theorem/lemma is closed by an uninformative constant
  - `64: `
- L93: **SOFT** `vacuous-prop-constant` in `theorem chiralToComplex_im`
  - theorem/lemma is closed by an uninformative constant
  - `91: `
...
- L27: **SOFT** `vacuous-prop-constant` in `lemma KL_param_eq_bregman_swap`
  - theorem/lemma is closed by an uninformative constant
...
- L189: **SOFT** `vacuous-prop-constant` in `lemma mem_evenSubmodule_iff`
  - theorem/lemma is closed by an uninformative constant
  - `187:         _ = a • (-x) := by rw [hx]`
- L193: **SOFT** `vacuous-prop-constant` in `lemma mem_oddSubmodule_iff`
  - theorem/lemma is closed by an uninformative constant
...
- L173: **SOFT** `vacuous-prop-constant` in `lemma apply_add`
  - theorem/lemma is closed by an uninformative constant
  - `171: `
- L175: **SOFT** `vacuous-prop-constant` in `lemma apply_add`
  - theorem/lemma is closed by an uninformative constant
  - `173: `
- L177: **SOFT** `vacuous-prop-constant` in `lemma apply_smul`
  - theorem/lemma is closed by an uninformative constant
  - `175: `
- L179: **SOFT** `vacuous-prop-constant` in `lemma apply_smul`
  - theorem/lemma is closed by an uninformative constant
  - `177: `
...
- L60: **SOFT** `vacuous-prop-constant` in `lemma logLikelihood_eq_neg_logDensity`
  - theorem/lemma is closed by an uninformative constant
...
- L324: **SOFT** `skeletal-proof` in `lemma signFlipMap_apply`
  - proof appears to be tactic-automation-only or skeletal
  - `322: `
...
- L32: **SOFT** `vacuous-prop-constant` in `theorem normalizedWeights_eq_finite_gibbsWeight`
  - theorem/lemma is closed by an uninformative constant
  - `30: `
...
- findings: 1 (hard=1, soft=0)

- L23: **HARD** `proof-hole` in `def pauliLinter`
  - declaration body contains sorry/admit placeholder
...
- L84: **HARD** `proof-hole` in `def collectHardEvidence`
  - declaration body contains sorry/admit placeholder
...
- L345: **SOFT** `vacuous-prop-constant` in `theorem diagonal_shadow_available`
  - theorem/lemma is closed by an uninformative constant
...
- L104: **SOFT** `vacuous-prop-constant` in `theorem act_mul_op`
  - theorem/lemma is closed by an uninformative constant
  - `102: `
...
- L760: **SOFT** `vacuous-prop-constant` in `theorem act_map_zero`
  - theorem/lemma is closed by an uninformative constant
  - `758: `
...
- L20: **SOFT** `vacuous-prop-constant` in `lemma map_smul_gauge`
  - theorem/lemma is closed by an uninformative constant
  - `18: `
...
- L107: **SOFT** `vacuous-prop-constant` in `lemma modular_j_gauge_equivariant`
  - theorem/lemma is closed by an uninformative constant
  - `105:     projectiveMapEven A hA (projectivize (u • v)) = projectiveMapEven A hA (projectivize v) :=`
- L112: **SOFT** `vacuous-prop-constant` in `lemma spectral_epsilon_gauge_equivariant`
  - theorem/lemma is closed by an uninformative constant
  - `110:     modular_j (u • v) = u • modular_j v := by`
- L117: **SOFT** `vacuous-prop-constant` in `lemma complex_i_gauge_equivariant`
  - theorem/lemma is closed by an uninformative constant
...
- L227: **SOFT** `vacuous-prop-constant` in `lemma roundTrip_smul_eq_smulRoundTrip`
  - theorem/lemma is closed by an uninformative constant
...
- path: `lean/InfoGeometry/Singular/MoorePenrose.lean`
- findings: 1 (hard=0, soft=1)

- L57: **SOFT** `skeletal-proof` in `lemma adjoint_mul_triple`
  - proof appears to be tactic-automation-only or skeletal
  - `55: `
...
- L157: **SOFT** `skeletal-proof` in `theorem drazinRegularProjector_idempotent`
  - proof appears to be tactic-automation-only or skeletal
  - `155:     (hD : IsDrazinInverse A D k) : R :=`
- L193: **SOFT** `skeletal-proof` in `theorem drazinRegular_add_drazinNull`
  - proof appears to be tactic-automation-only or skeletal
  - `191:       drazinNullProjector A D k hD := by`
- L238: **SOFT** `skeletal-proof` in `theorem moorePenroseRangeProjector_idempotent`
  - proof appears to be tactic-automation-only or skeletal
  - `236:     (hMP : IsMoorePenroseInverse A B) : R :=`
- L247: **SOFT** `skeletal-proof` in `theorem moorePenroseRangeProjector_self_adjoint`
  - proof appears to be tactic-automation-only or skeletal
  - `245:       moorePenroseRangeProjector A B hMP := by`
...
- L329: **SOFT** `injected-hypothesis-surface` in `variable <file-level>`
  - section variable assumptions detected
  - `327: `
- L491: **SOFT** `injected-hypothesis-surface` in `variable <file-level>`
  - section variable assumptions detected
  - `489: `
...
- L90: **SOFT** `vacuous-prop-constant` in `theorem netOddShadow_eq_right_minus_left`
  - theorem/lemma is closed by an uninformative constant
...
- L74: **SOFT** `skeletal-proof` in `theorem coordinate_i`
  - proof appears to be tactic-automation-only or skeletal
  - `72:   else`
- L127: **SOFT** `vacuous-prop-constant` in `theorem cartan_rank_four`
  - theorem/lemma is closed by an uninformative constant
  - `125: `
...
- L152: **SOFT** `vacuous-prop-constant` in `theorem ofPorts_portCompatible_iff`
  - theorem/lemma is closed by an uninformative constant
  - `150:   · intro h`
...
- L101: **SOFT** `vacuous-prop-constant` in `theorem ofFinPorts_portCompatible_iff`
  - theorem/lemma is closed by an uninformative constant
  - `99:     ofPorts_inScope_iff (TensorPort.ofFin source) (TensorPort.ofFin target) binderDepth`
- L186: **SOFT** `vacuous-prop-constant` in `theorem ofFinPorts_portCompatible_iff`
  - theorem/lemma is closed by an uninformative constant
...
- L93: **SOFT** `vacuous-prop-constant` in `theorem ofPorts_portCompatible_iff`
  - theorem/lemma is closed by an uninformative constant
...
- L178: **SOFT** `vacuous-prop-constant` in `lemma internalEnergy_eq_gibbsExpectation`
  - theorem/lemma is closed by an uninformative constant
  - `176: `
...
- L49: **SOFT** `vacuous-prop-constant` in `theorem weylAction_eq_dilation_volumeScale`
  - theorem/lemma is closed by an uninformative constant
