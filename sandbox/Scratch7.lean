...
theorem amplituhedronVolume_two :
  ...
  have h_basel := Mathlib.NumberTheory.ZetaValues.hasSum_zeta_two.tsum_eq
  rw [Mathlib.NumberTheory.ZetaValues.hasSum_zeta_two.summable.tsum_eq_zero_add] at h_basel
