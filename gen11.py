...
{get_haves()}
    have h_eq : ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 2) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3)) = (Q (HasSpacetimeBasis.gamma Q 0) * Q (HasSpacetimeBasis.gamma Q 2)) • basisBivector Q 4 := by
      calc ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 2) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3))
        ...
        _ = algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 0)) * (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 2)) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 3)) := by rw [a1 (ι Q (HasSpacetimeBasis.gamma Q 1)) (Q (HasSpacetimeBasis.gamma Q 2))]
        _ = algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 0)) * algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 2)) * (ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 3)) := by simp only [mul_assoc]
...
{get_haves()}
    have h_eq : ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 3) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3)) = (- (Q (HasSpacetimeBasis.gamma Q 0) * Q (HasSpacetimeBasis.gamma Q 3))) • basisBivector Q 5 := by
      calc ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 3) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3))
        ...
        _ = - (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 0)) * (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 3)) * (ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2)))) := by rw [a1 (ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2)) (Q (HasSpacetimeBasis.gamma Q 3))]
        _ = - (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 0)) * algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 3)) * (ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2))) := by simp only [mul_assoc]
...
{get_haves()}
    have h_eq : ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3)) = (- (Q (HasSpacetimeBasis.gamma Q 2) * Q (HasSpacetimeBasis.gamma Q 3))) • basisBivector Q 0 := by
      calc ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3))
        ...
        _ = - (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 2)) * algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 3)) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1))) := by rw [a1 (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1)) (Q (HasSpacetimeBasis.gamma Q 2) * Q (HasSpacetimeBasis.gamma Q 3)), map_mul]
        _ = (- (Q (HasSpacetimeBasis.gamma Q 2) * Q (HasSpacetimeBasis.gamma Q 3))) • basisBivector Q 0 := by dsimp [basisBivector, gamma]; rw [Algebra.smul_def, map_neg, map_mul, neg_mul]
    rw [h_eq]
    apply Submodule.smul_mem
    apply Submodule.subset_span
...
{get_haves()}
    have h_eq : ι Q (HasSpacetimeBasis.gamma Q 3) * ι Q (HasSpacetimeBasis.gamma Q 1) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3)) = (- (Q (HasSpacetimeBasis.gamma Q 1) * Q (HasSpacetimeBasis.gamma Q 3))) • basisBivector Q 1 := by
      calc ι Q (HasSpacetimeBasis.gamma Q 3) * ι Q (HasSpacetimeBasis.gamma Q 1) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3))
        ...
        _ = ι Q (HasSpacetimeBasis.gamma Q 0) * (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 1)) * ι Q (HasSpacetimeBasis.gamma Q 3)) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3) := by rw [a1 (ι Q (HasSpacetimeBasis.gamma Q 3)) (Q (HasSpacetimeBasis.gamma Q 1))]; simp only [mul_assoc]
        _ = algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 1)) * ι Q (HasSpacetimeBasis.gamma Q 0) * (ι Q (HasSpacetimeBasis.gamma Q 3) * ι Q (HasSpacetimeBasis.gamma Q 2)) * ι Q (HasSpacetimeBasis.gamma Q 3) := by rw [a1 (ι Q (HasSpacetimeBasis.gamma Q 0)) (Q (HasSpacetimeBasis.gamma Q 1))]; simp only [mul_assoc]
        ...
        _ = - (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 1)) * (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 3)) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 2)))) := by rw [a1 (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 2)) (Q (HasSpacetimeBasis.gamma Q 3))]; simp only [mul_assoc]
        _ = (- (Q (HasSpacetimeBasis.gamma Q 1) * Q (HasSpacetimeBasis.gamma Q 3))) • basisBivector Q 1 := by dsimp [basisBivector, gamma]; rw [Algebra.smul_def, map_neg, map_mul, neg_mul]; simp only [mul_assoc]
    rw [h_eq]
    apply Submodule.smul_mem
    apply Submodule.subset_span
...
{get_haves()}
    have h_eq : ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3)) = (- (Q (HasSpacetimeBasis.gamma Q 1) * Q (HasSpacetimeBasis.gamma Q 2))) • basisBivector Q 2 := by
      calc ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * (ι Q (HasSpacetimeBasis.gamma Q 0) * ι Q (HasSpacetimeBasis.gamma Q 1) * ι Q (HasSpacetimeBasis.gamma Q 2) * ι Q (HasSpacetimeBasis.gamma Q 3))
        ...
        _ = - (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 1)) * (algebraMap R _ (Q (HasSpacetimeBasis.gamma Q 2)) * ι Q (HasSpacetimeBasis.gamma Q 0)) * ι Q (HasSpacetimeBasis.gamma Q 3)) := by rw [a1 (ι Q (HasSpacetimeBasis.gamma Q 0)) (Q (HasSpacetimeBasis.gamma Q 2))]
        _ = (- (Q (HasSpacetimeBasis.gamma Q 1) * Q (HasSpacetimeBasis.gamma Q 2))) • basisBivector Q 2 := by dsimp [basisBivector, gamma]; rw [Algebra.smul_def, map_neg, map_mul, neg_mul]; simp only [mul_assoc]
    rw [h_eq]
    apply Submodule.smul_mem
    apply Submodule.subset_span
...
with open("generate_lean11.py", "w") as f:
    f.write(out)
