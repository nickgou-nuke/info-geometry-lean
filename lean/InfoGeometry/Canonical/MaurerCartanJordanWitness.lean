...
Finite property-alias packet for the nilpotent/Jordan truncation corridor.

This file does not introduce new closure theory. It exposes the already-owned
finite theorems that property the same truncation pattern:

- square-zero nilpotent correction;
- Jordan-cell power collapse;
- Hadjiivanov phase-times-nilpotent readout.

The corresponding SymPy property is `tools/sympy/maurer_cartan_jordan_truncation.py`.
-/
...
/-- SymPy property alias: square-zero nilpotent Jordan power. -/
...
/-- SymPy property alias: Hadjiivanov monodromy power law. -/
...
/-- SymPy property alias: lower Hadjiivanov exchange block factors through the conjugated nilpotent corridor. -/
