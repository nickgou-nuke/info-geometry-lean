...
G9_2_DEGENERACY = 9 + 1
CONFIG_COUNT = comb(G9_2_DEGENERACY, PROTON_HOLES) * comb(G9_2_DEGENERACY, NEUTRON_HOLES)
...
assert 2 * 8 + 1 == 17 and 2 * 14 + 1 == 29
assert 205 - 25 == 180 and 205 + 34 == 239
assert 205 < 250
assert Fraction(84, 100) == Fraction(21, 25)
assert Fraction(11, 10) < Fraction(3, 2)

table = {
    "14_to_12": dict(exp=Fraction(521, 10), jun45=101, gds=49, full=112, t0=82, t1=9, exvam=56),
...
assert abs(table["14_to_12"]["gds"] - table["14_to_12"]["exp"]) == Fraction(31, 10)
...
print({
    ...
    "gds_neutron_charge": Fraction(21, 25),
