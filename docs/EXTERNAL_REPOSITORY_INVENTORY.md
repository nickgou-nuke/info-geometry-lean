...
- added directly from upstream after audit: `LeanEuclid`;
...
The follow-up audit checked 92 nested git repositories under:
...
`sympy`, `vampire`, `z3`, the newly cloned archive repos, and `LeanEuclid`.
