...
start_str = "  have h10 : "
end_str = "theorem hodge_preserves_bivector"

start_idx = content.find(start_str)
end_idx = content.find(end_str)

new_content = content[:start_idx] + h_block + "\n" + content[end_idx:]

open("lean/InfoGeometry/Canonical/HestenesBivectorCarrier.lean", "w").write(new_content)
