...
def test_zero_deviation_constructor_exposes_zero_residual_flow_route() -> None:
    ...
    assert "theorem observerDefectResidual_norm_le_ZD_of_deviation_eq_zero" in observer_text
    ...
    assert "observerDefectResidual_norm_le_ZD_of_deviation_eq_zero" in triality_text
