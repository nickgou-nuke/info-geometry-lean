...
/-! The finite matrix units generated by the concrete O₄ family. -/

/-- The `(i,j)` matrix unit is the product of the `i`-creation and
    `j`-annihilation branches. -/
def matrixUnit (i j : Fin 4) : C4Functions →ₗ[ℂ] C4Functions :=
  cuntzS i * cuntzT j
