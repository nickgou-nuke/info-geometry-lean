...
theorem property1_minimal_polynomial : X * X - X - 1 = 0 := by
  rw [X_sq]
  abel

theorem property1_resolvent_identity (mu : ℂ) (hA : IsUnit (mu • (1 : Matrix (Fin 2) (Fin 2) ℂ) - A)) :
...
theorem property2_power_calculus (k : ℕ) :
...
theorem property3_shift_commutes_with_matrix (n : ℕ) (M : Matrix (Fin n) (Fin n) ℂ) (x : CuntzAlg n) :
...
theorem property4_nonabelian (h_inj : Function.Injective (matrixToCuntz 2)) :
...
theorem property5_rank_one_projection_equivalence :
