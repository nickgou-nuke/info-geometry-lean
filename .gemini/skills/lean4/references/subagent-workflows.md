...
[Agent reports back]:
- Sorries: 3 total (all documented with FIXME comments)
...
Line 245 - theorem convergence_main
  FIXME: Need monotone convergence theorem from mathlib
...
- Use filtering: "only report sorries with no FIXME comments"
