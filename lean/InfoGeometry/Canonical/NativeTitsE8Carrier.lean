...
theorem finrank_splitOctonionTraceZero :
  ...
  have h := zornTraceLinear.finrank_ker_add_one_of_ne_zero zornTraceLinear_ne_zero
...
theorem finrank_h3TraceZero :
  ...
  have h := h3TraceLinear.finrank_ker_add_one_of_ne_zero h3TraceLinear_ne_zero
...
theorem finrank_g2_plus_mixed :
  ...
  simp [finrank_g2DerivationCarrier, finrank_mixedCarrier]
...
theorem finrank_nativeTitsCarrier_of_f4
  ...
  simp [NativeTitsCarrier, finrank_g2DerivationCarrier,
    finrank_mixedCarrier, hF4]
