...
As725_BE1 = Q(14) / 10000000
Se717_BE1 = Q(4) / 10000000
As725_ME1 = Q(37) / 10000
Se717_ME1 = Q(20) / 10000

As319_BE1 = Q(83) / 10000000
Se303_BE1_upper = Q(14) / 10000000
As319_ME1 = Q(91) / 10000
Se303_ME1_upper = Q(37) / 10000
...
charge_correction_1MeV = Q(190) / 10000000
magnetic_correction_1MeV = Q(53) / 100000
