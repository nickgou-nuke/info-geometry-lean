...
theorem fib_three_eq : Nat.fib 3 = 2 := by decide

/-- F_4 = 3: minimal degeneracy degree for window m = 8.
    thm:conclusion-foldbin-minideal-fibonacci-primitive-splitting -/
theorem fib_four_eq : Nat.fib 4 = 3 := by decide

/-- F_5 = 5: minimal degeneracy degree for window m = 10.
    thm:conclusion-foldbin-minideal-fibonacci-primitive-splitting -/
theorem fib_five_eq : Nat.fib 5 = 5 := by decide
...
/-- For audited even windows, |Prim_min| = F_m and |Prim_rest| = F_{m+1},
    ...
    thm:conclusion-foldbin-minideal-fibonacci-primitive-splitting -/
theorem prim_spectrum_sum_m6 : Nat.fib 6 + Nat.fib 7 = Nat.fib 8 := by decide

theorem prim_spectrum_sum_m8 : Nat.fib 8 + Nat.fib 9 = Nat.fib 10 := by decide

theorem prim_spectrum_sum_m10 : Nat.fib 10 + Nat.fib 11 = Nat.fib 12 := by decide

theorem prim_spectrum_sum_m12 : Nat.fib 12 + Nat.fib 13 = Nat.fib 14 := by decide
