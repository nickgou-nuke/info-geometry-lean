...
This isolated corridor closes the explicit finite classification debt
...
No canonical owner file is imported or modified here.

#### BUCKET 1: CLOSED FINITE THEOREMS
Explicit Pauli representation, block-splitting projectors, surjectivity,
finite-dimensional rank calculation, injectivity, and the resulting algebra
equivalence.
...
noncomputable def chirality : CliffordAlgebra q3 := algebraMap ℂ (CliffordAlgebra q3) (-Complex.I) * volume
...
lemma s1_mul_s2_mul_s3 : s1 * s2 * s3 = Complex.I • (1 : Mat2C) := by
  ext i j <;> fin_cases i <;> fin_cases j <;> simp [s1, s2, s3, Matrix.mul_apply, Fin.sum_univ_two]
