...
/-! Actual spatial response, first-collision path integral, and finite-aperture reference.
No point-detector reduction is an axiom, a structure field, or an integral definition. -/
