...
theorem named_kantor_component_packet :
  ...
  exact ⟨gradingOperator_isTripotent,
    (hasGrade_iff_isCommutatorComponent (-2) pairAnnihilation).1
      pairAnnihilation_grade,
    (hasGrade_iff_isCommutatorComponent (-1) a1).1 a1_grade,
    (hasGrade_iff_isCommutatorComponent 0 (comm a1 a1Dag)).1
      mixed_a1_a1Dag_grade_zero,
    (hasGrade_iff_isCommutatorComponent 1 a1Dag).1 a1Dag_grade,
    (hasGrade_iff_isCommutatorComponent 2 pairCreation).1
      pairCreation_grade⟩
