...
/-- Publication-facing wrapper for reconstruction from a single root-of-unity
layer in the ETDS finite-part section.
    thm:finite-part-cyclic-lift-single-q-torsion-reconstruction -/
theorem paper_etds_finite_part_single_q_torsion_reconstruction
  ...
  exact
    (paper_etds_intro_cyclic_reconstruction_package
      ...
      singleLayerDetermines exponentialFingerprint hdet hspec hsingle hexp).2.1 hq
