...
This module contains the reusable algebraic projector spectral-power theorem.
-/

noncomputable section

namespace InfoGeometry.Canonical.ProjectorSpectralPower

open scoped BigOperators

/-- Orthogonal finite projector spectral-power theorem. -/
...
end InfoGeometry.Canonical.ProjectorSpectralPower
