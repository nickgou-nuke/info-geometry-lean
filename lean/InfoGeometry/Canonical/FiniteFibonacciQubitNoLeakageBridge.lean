...
open FiniteFibonacciQubitNoLeakage
...
theorem computational_vector_card (N : ℕ) :
  ...
  FiniteFibonacciComputationalSpace.card_computationalVector N
...
theorem fibonacci_block_dimension_eq_fib (N : ℕ) :
  ...
  FiniteFibonacciComputationalSpace.fibonacciBlockDimension_eq_fib N
...
theorem tau_inv_sq_truncation {τ : ℚ} (hτ0 : τ ≠ 0) (hτ : τ ^ 2 + τ = 1) :
  ...
  FiniteFibonacciQubitNoLeakage.tau_inv_sq_truncation hτ0 hτ
...
theorem oneQubit_b1_eq_b3 (qNeg4 q3 : ℂ)
  ...
  FiniteFibonacciQubitNoLeakage.oneQubit_b1_eq_b3 qNeg4 q3 B
...
theorem twoQubitNoLeakageAction_preserves_computational
  ...
  FiniteFibonacciQubitNoLeakage.twoQubitNoLeakageAction_preserves_computational k f hx
...
theorem twoQubitNoLeakageAction_nc
  ...
  FiniteFibonacciQubitNoLeakage.twoQubitNoLeakageAction_nc k f
...
theorem twoQubit_computational_card :
  ...
  FiniteFibonacciQubitNoLeakage.twoQubit_computational_card

/-- The `N = 2` finite count has one NC label. -/
theorem twoQubit_nc_count :
    nonComputationalCount 2 = 1 :=
  FiniteFibonacciQubitNoLeakage.twoQubit_nc_count
