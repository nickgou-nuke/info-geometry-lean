...
lemma Witt_e_plus_sq (x : SplitOctonion) :
  ...
  ext <;> simp [Witt_e_plus, Gamma_sheet, K_sheet, J_sheet, smul_add, add_smul, smul_sub] <;> try ring

lemma Witt_e_minus_sq (x : SplitOctonion) :
    Witt_e_minus (Witt_e_minus x) = 0 := by
  ext <;> simp [Witt_e_minus, Gamma_sheet, K_sheet, J_sheet, smul_add, add_smul, smul_sub] <;> try ring

lemma Witt_e_anticomm (x : SplitOctonion) :
    Witt_e_plus (Witt_e_minus x) + Witt_e_minus (Witt_e_plus x) = x := by
  ext <;> simp [Witt_e_plus, Witt_e_minus, Gamma_sheet, K_sheet, J_sheet, smul_add, add_smul, smul_sub] <;> try ring
