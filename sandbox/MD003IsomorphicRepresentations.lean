...
theorem biquatUnit1_sq : biquatUnit1 * biquatUnit1 = -biquatUnit0 := by
  ext i j <;> fin_cases i <;> fin_cases j <;>
...
theorem biquatUnit2_sq : biquatUnit2 * biquatUnit2 = -biquatUnit0 := by
  ext i j <;> fin_cases i <;> fin_cases j <;>
    simp [biquatUnit0, biquatUnit2, biquatMatrix, UnifiedMatrixBasis.I₂,
      UnifiedMatrixBasis.σ₁, UnifiedMatrixBasis.σ₂, UnifiedMatrixBasis.σ₃,
      Matrix.mul_apply, Fin.sum_univ_two, Complex.I_sq]

theorem biquatUnit3_sq : biquatUnit3 * biquatUnit3 = -biquatUnit0 := by
  ext i j <;> fin_cases i <;> fin_cases j <;>
    simp [biquatUnit0, biquatUnit3, biquatMatrix, UnifiedMatrixBasis.I₂,
      UnifiedMatrixBasis.σ₁, UnifiedMatrixBasis.σ₂, UnifiedMatrixBasis.σ₃,
      Matrix.mul_apply, Fin.sum_univ_two, Complex.I_sq]

theorem biquatUnit1_mul_biquatUnit2 : biquatUnit1 * biquatUnit2 = biquatUnit3 := by
  ext i j <;> fin_cases i <;> fin_cases j <;>
...
theorem biquatUnit2_mul_biquatUnit3 : biquatUnit2 * biquatUnit3 = biquatUnit1 := by
  ext i j <;> fin_cases i <;> fin_cases j <;>
    simp [biquatUnit1, biquatUnit2, biquatUnit3, biquatMatrix,
      UnifiedMatrixBasis.I₂, UnifiedMatrixBasis.σ₁, UnifiedMatrixBasis.σ₂,
      UnifiedMatrixBasis.σ₃, Matrix.mul_apply, Fin.sum_univ_two, Complex.I_sq]

theorem biquatUnit3_mul_biquatUnit1 : biquatUnit3 * biquatUnit1 = biquatUnit2 := by
  ext i j <;> fin_cases i <;> fin_cases j <;>
    simp [biquatUnit1, biquatUnit2, biquatUnit3, biquatMatrix,
      UnifiedMatrixBasis.I₂, UnifiedMatrixBasis.σ₁, UnifiedMatrixBasis.σ₂,
      UnifiedMatrixBasis.σ₃, Matrix.mul_apply, Fin.sum_univ_two, Complex.I_sq]

theorem biquat_trace_recover_q0 (q0 q1 q2 q3 : ℂ) :
    traceForm UnifiedMatrixBasis.I₂ (biquatMatrix q0 q1 q2 q3) / 2 = q0 := by
  unfold traceForm biquatMatrix
  simp [UnifiedMatrixBasis.I₂, UnifiedMatrixBasis.σ₁, UnifiedMatrixBasis.σ₂,
    UnifiedMatrixBasis.σ₃, Matrix.mul_apply, Fin.sum_univ_two]

theorem biquat_trace_recover_q1 (q0 q1 q2 q3 : ℂ) :
    Complex.I * traceForm UnifiedMatrixBasis.σ₁ (biquatMatrix q0 q1 q2 q3) / 2 = q1 := by
  unfold traceForm biquatMatrix
  simp [UnifiedMatrixBasis.I₂, UnifiedMatrixBasis.σ₁, UnifiedMatrixBasis.σ₂,
    UnifiedMatrixBasis.σ₃, Matrix.mul_apply, Fin.sum_univ_two]
  ring_nf
...
theorem biquat_trace_recover_q2 (q0 q1 q2 q3 : ℂ) :
    Complex.I * traceForm UnifiedMatrixBasis.σ₂ (biquatMatrix q0 q1 q2 q3) / 2 = q2 := by
  unfold traceForm biquatMatrix
  simp [UnifiedMatrixBasis.I₂, UnifiedMatrixBasis.σ₁, UnifiedMatrixBasis.σ₂,
    UnifiedMatrixBasis.σ₃, Matrix.mul_apply, Fin.sum_univ_two]
  ring_nf
...
theorem biquat_trace_recover_q3 (q0 q1 q2 q3 : ℂ) :
