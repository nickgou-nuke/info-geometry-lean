...
namespace Omega.Topos.FocusedSheafLocalToGlobalAPAL

set_option maxHeartbeats 400000 in
/-- Focused APAL publication wrapper for the sheaf-at-a-reference corollary.
    cor:sheaf-local-to-global -/
theorem paper_conservative_extension_sheaf_local_to_global_focused_apal
...
end Omega.Topos.FocusedSheafLocalToGlobalAPAL
