...
with open(".agents/sandbox_connes_hodge/audit/audit_token_scan.log", "w") as f:
...
with open(".agents/sandbox_connes_hodge/audit/audit_declaration_fidelity.log", "w") as f:
