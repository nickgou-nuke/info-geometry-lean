...
theorem paper_fib_lie_resonance_orthogonal_symplectic :
  ...
  refine ⟨by decide, by decide, by decide, by decide,
    ⟨2, by decide, rfl⟩, ⟨6, by decide, rfl⟩, ⟨10, by decide, rfl⟩⟩
...
/-- cor:gut-fibprime-pisano-4n -/
theorem pisano_period_17 : Nat.fib 36 % 17 = 0 ∧ Nat.fib 37 % 17 = 1 := by decide

/-- cor:gut-fibprime-pisano-4n -/
theorem pisano_period_19 : Nat.fib 18 % 19 = 0 ∧ Nat.fib 19 % 19 = 1 := by decide

/-- cor:gut-fibprime-pisano-4n -/
theorem pisano_period_23 : Nat.fib 48 % 23 = 0 ∧ Nat.fib 49 % 23 = 1 := by decide
...
theorem pisano_period_29 : Nat.fib 14 % 29 = 0 ∧ Nat.fib 15 % 29 = 1 := by decide
...
/-- Pisano period for p = 31: π(31) = 30.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_31 : Nat.fib 30 % 31 = 0 ∧ Nat.fib 31 % 31 = 1 := by decide

/-- Pisano period for p = 47: π(47) = 32.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_47 : Nat.fib 32 % 47 = 0 ∧ Nat.fib 33 % 47 = 1 := by decide
...
/-- Pisano period for p = 41: π(41) = 40.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_41 : Nat.fib 40 % 41 = 0 ∧ Nat.fib 41 % 41 = 1 := by decide

/-- Pisano period for p = 59: π(59) = 58.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_59 : Nat.fib 58 % 59 = 0 ∧ Nat.fib 59 % 59 = 1 := by decide
...
/-- Pisano period for p = 61: π(61) = 60.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_61 : Nat.fib 60 % 61 = 0 ∧ Nat.fib 61 % 61 = 1 := by decide

/-- Pisano period for p = 71: π(71) = 70.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_71 : Nat.fib 70 % 71 = 0 ∧ Nat.fib 71 % 71 = 1 := by decide
...
/-- Pisano period for p = 89: π(89) = 44.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_89 : Nat.fib 44 % 89 = 0 ∧ Nat.fib 45 % 89 = 1 := by decide
...
/-- Pisano period for p = 101: π(101) = 50.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_101 : Nat.fib 50 % 101 = 0 ∧ Nat.fib 51 % 101 = 1 := by decide
...
/-- Pisano period for p = 107: π(107) = 72.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_107 : Nat.fib 72 % 107 = 0 ∧ Nat.fib 73 % 107 = 1 := by decide

/-- Pisano period for p = 113: π(113) = 76.
    prop:gu-fibprime-pisano-periods -/
theorem pisano_period_113 : Nat.fib 76 % 113 = 0 ∧ Nat.fib 77 % 113 = 1 := by decide
...
theorem pisano_period_67 :
    Nat.fib 136 % 67 = 0 ∧ Nat.fib 137 % 67 = 1 := by decide

/-- Pisano period π(73) = 148.
    cor:field-phase-fib-prime -/
theorem pisano_period_73 :
    Nat.fib 148 % 73 = 0 ∧ Nat.fib 149 % 73 = 1 := by decide

/-- Pisano period π(79) = 78.
    cor:field-phase-fib-prime -/
theorem pisano_period_79 :
    Nat.fib 78 % 79 = 0 ∧ Nat.fib 79 % 79 = 1 := by decide
