...
- Declarations Audited: `8394`
- Anchored: `7502`
- Unanchored (Closure Debt): `892`
...
| `def` | `energy` | `lean/SelfReference/RobustThermodynamicRegression.lean:36` |
| `def` | `fisherStiffness` | `lean/SelfReference/RobustThermodynamicRegression.lean:66` |
| `def` | `exactHessian` | `lean/SelfReference/RobustThermodynamicRegression.lean:83` |
| `def` | `isResolvable` | `lean/SelfReference/RobustThermodynamicRegression.lean:93` |
| `theorem` | `phase_transition_catastrophe` | `lean/SelfReference/RobustThermodynamicRegression.lean:101` |
...
| `lemma` | `regTotalCount_eq_Z_regularizedPositiveMeasure` | `lean/InfoGeometry/RegularizedKL.lean:40` |
| `lemma` | `regTotalCount_pos` | `lean/InfoGeometry/RegularizedKL.lean:51` |
| `lemma` | `regularizedPMF_strictly_pos` | `lean/InfoGeometry/RegularizedKL.lean:73` |
| `theorem` | `regularizedGeneralizedKL_nonneg` | `lean/InfoGeometry/RegularizedKL.lean:105` |
| `theorem` | `regularized_kl_is_safe` | `lean/InfoGeometry/RegularizedKL.lean:120` |
| `lemma` | `sum_regularizedPMF_eq_one` | `lean/InfoGeometry/RegularizedKL.lean:131` |
...
| `def` | `DeclRole` | `lean/InfoGeometry/Meta/StrictSurface.lean:19` |
...
| `theorem` | `finite_prime_weyl_denominator` | `lean/InfoGeometry/Canonical/FormalPrimeRootSystem.lean:75` |
| `theorem` | `finite_denominator_identity` | `lean/InfoGeometry/Canonical/FormalPrimeRootSystem.lean:83` |
...
| `def` | `finiteFermionTrace` | `lean/InfoGeometry/Canonical/PrimeGasPartitions.lean:47` |
| `def` | `finiteParityTrace` | `lean/InfoGeometry/Canonical/PrimeGasPartitions.lean:52` |
| `theorem` | `bosonTrace_eq_zeta` | `lean/InfoGeometry/Canonical/PrimeGasPartitions.lean:74` |
| `theorem` | `fermionTrace_eq_zeta_div_zeta_two_beta` | `lean/InfoGeometry/Canonical/PrimeGasPartitions.lean:79` |
| `theorem` | `parityTrace_eq_inverse_zeta` | `lean/InfoGeometry/Canonical/PrimeGasPartitions.lean:84` |
...
| `theorem` | `isNormalInference_of_incompressibleBit_of_chiralScale_eq_neg_cramerRaoLogVolume` | `lean/InfoGeometry/Canonical/IncompressibleCramerRaoActionBridge.lean:146` |
| `theorem` | `unitOfAction_eq_metricVolumePotential` | `lean/InfoGeometry/Canonical/IncompressibleCramerRaoActionBridge.lean:168` |
| `theorem` | `epsilon_eq_metricVolumePotential` | `lean/InfoGeometry/Canonical/IncompressibleCramerRaoActionBridge.lean:181` |
| `theorem` | `anomalyReadoutPacket_eq_metricVolumePotential` | `lean/InfoGeometry/Canonical/IncompressibleCramerRaoActionBridge.lean:195` |
| `theorem` | `unitOfAction_eq_zero_of_incompressible` | `lean/InfoGeometry/Canonical/IncompressibleCramerRaoActionBridge.lean:209` |
| `theorem` | `projectorObstruction_eq_zero_and_dilationCommutator_eq_zero_of_incompressible` | `lean/InfoGeometry/Canonical/IncompressibleCramerRaoActionBridge.lean:223` |
| `theorem` | `semanticCollapsePacket_of_incompressible` | `lean/InfoGeometry/Canonical/IncompressibleCramerRaoActionBridge.lean:253` |
...
| `theorem` | `structuredSouriauKKTTranslatorPacket_ofExactResiduals` | `lean/InfoGeometry/Canonical/SouriauTheoremTranslatorPacket.lean:786` |
| `theorem` | `structuredSouriauKKTTranslatorPacket_ofExactResiduals_det_nonneg` | `lean/InfoGeometry/Canonical/SouriauTheoremTranslatorPacket.lean:827` |
...
| `theorem` | `claimCD_fullCoadjointOrbit_strict_hessian_packet` | `lean/InfoGeometry/Canonical/SouriauTheoremTranslatorPacket.lean:912` |
| `theorem` | `claimCDE_fullCoadjointOrbit_hessian_metriplectic_packet` | `lean/InfoGeometry/Canonical/SouriauTheoremTranslatorPacket.lean:938` |
| `theorem` | `claimCDE_fullCoadjointOrbit_strict_hessian_metriplectic_packet` | `lean/InfoGeometry/Canonical/SouriauTheoremTranslatorPacket.lean:966` |
...
| `def` | `rootThermalEvaluation` | `lean/InfoGeometry/Canonical/SouriauThermalEvaluation.lean:60` |
| `def` | `finiteParityProduct` | `lean/InfoGeometry/Canonical/SouriauThermalEvaluation.lean:66` |
| `def` | `finiteParitySubsetSum` | `lean/InfoGeometry/Canonical/SouriauThermalEvaluation.lean:72` |
...
| `def` | `nOfSubset` | `lean/InfoGeometry/Canonical/ParityTraceWitness.lean:31` |
| `theorem` | `mobius_on_subset_eq_weyl_sign` | `lean/InfoGeometry/Canonical/ParityTraceWitness.lean:77` |
| `theorem` | `nonsquarefree_not_represented_by_boolean_prime_state` | `lean/InfoGeometry/Canonical/ParityTraceWitness.lean:84` |
| `theorem` | `parityCoeff_eq_mobius` | `lean/InfoGeometry/Canonical/ParityTraceWitness.lean:92` |
| `theorem` | `fermionCoeff_eq_abs_mobius` | `lean/InfoGeometry/Canonical/ParityTraceWitness.lean:98` |
...
| `theorem` | `names` | `lean/InfoGeometry/Canonical/All.lean:532` |
| `theorem` | `canopy_thermo_equilibrium_and_entropy` | `lean/InfoGeometry/Canonical/GrandSynthesis.lean:35` |
| `theorem` | `canopy_geometric_component_constant` | `lean/InfoGeometry/Canonical/GrandSynthesis.lean:49` |
| `theorem` | `canopy_singular_boundary_closure` | `lean/InfoGeometry/Canonical/GrandSynthesis.lean:64` |
| `theorem` | `grandSynthesis_trunk_to_canopy_closure` | `lean/InfoGeometry/Canonical/GrandSynthesis.lean:74` |
| `theorem` | `grandSynthesis_root_factorization` | `lean/InfoGeometry/Canonical/GrandSynthesis.lean:99` |
...
| `theorem` | `operatorialFisherOnsager_entropyProduction_equation_of_squareResponse` | `lean/InfoGeometry/Canonical/SouriauLieThermoKKTBridge.lean:1099` |
| `theorem` | `operatorialFisherOnsager_entropyProduction_equation_of_regularCone` | `lean/InfoGeometry/Canonical/SouriauLieThermoKKTBridge.lean:1133` |
| `theorem` | `operatorialFisherOnsager_entropyProduction_equation_of_cramerRaoResponse` | `lean/InfoGeometry/Canonical/SouriauLieThermoKKTBridge.lean:1167` |
| `theorem` | `operatorialSouriauFisherMetric_packet_of_cramerRaoResponse` | `lean/InfoGeometry/Canonical/SouriauLieThermoKKTBridge.lean:1223` |
| `theorem` | `operatorialSupergradedEvenOddOnsagerBlock_packet_of_cramerRaoResponse` | `lean/InfoGeometry/Canonical/SouriauLieThermoKKTBridge.lean:1268` |
| `theorem` | `operatorialXChannel_entropyProduction_nonneg_of_regularCone` | `lean/InfoGeometry/Canonical/SouriauLieThermoKKTBridge.lean:1306` |
| `theorem` | `finite_and_operatorial_xChannel_entropyProduction_nonneg_of_regularCone` | `lean/InfoGeometry/Canonical/SouriauLieThermoKKTBridge.lean:1423` |
...
### Island 80 (7 decls)
  - `InfoGeometry.RegularizedKL.regTotalCount`
  - `InfoGeometry.RegularizedKL.regTotalCount_pos`
  - `InfoGeometry.RegularizedKL.regularizedPMF`
  - `InfoGeometry.RegularizedKL.regularizedPMF_eq`
  - `InfoGeometry.RegularizedKL.regularizedPMF_strictly_pos`
  - `InfoGeometry.RegularizedKL.regularized_kl_is_safe`
  - `InfoGeometry.RegularizedKL.sum_regularizedPMF_eq_one`
### Island 81 (7 decls)
...
### Island 101 (2 decls)
  - `InfoGeometry.RegularizedKL.regularizedGeneralizedKL`
  - `InfoGeometry.RegularizedKL.regularizedGeneralizedKL_nonneg`
### Island 102 (2 decls)
