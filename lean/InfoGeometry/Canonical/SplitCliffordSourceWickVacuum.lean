...
/--
External-lane readout: the charged Fock current datum canonically yields the
Sugawara morphism with its exact field and generator laws.
-/
theorem chargedFock_currentSugawaraMorphism_readout
