...
Compatibility aggregate for the upstream module path.  The canonical owners
for cross-ratio, Plücker/Klein, Arnold–Cohen, residue, and exterior nilpotency
laws remain the imported modules above; this file deliberately introduces no
duplicate carrier or theorem owner.
-/
