...
def Pchiral_matrix : Matrix (Fin 4) (Fin 4) ℂ := (1/2 : ℂ) • TLChain.e4

/-- `Pchiral_matrix² = Pchiral_matrix`. Same pattern as `TLChain.e4_sq`. -/
theorem Pchiral_matrix_sq : Pchiral_matrix * Pchiral_matrix = Pchiral_matrix := by
  ext i j
  fin_cases i <;> fin_cases j <;>
    simp [Pchiral_matrix, TLChain.e4, Matrix.mul_apply, Fin.sum_univ_four, Matrix.smul_apply] <;> norm_num
...
This closes the `ChiralLeftTauTarget` theorem. -/
