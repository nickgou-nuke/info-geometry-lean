...
This is a concrete zero model for the cellular DAG.  It uses identity edge
transport, empty face boundaries, and zero cochains, and proves the resulting
flatness and closedness interfaces.
-/
