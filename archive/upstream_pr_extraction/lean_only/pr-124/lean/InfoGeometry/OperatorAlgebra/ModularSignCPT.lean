...
/-! The four generating operators are exposed directly from the datum. -/

def scalarUnit : EndR H := 1

abbrev modularParity : EndR H := M.eps

abbrev modularReflection : EndR H := M.J

abbrev hestenesPhase : EndR H := M.Kmod
