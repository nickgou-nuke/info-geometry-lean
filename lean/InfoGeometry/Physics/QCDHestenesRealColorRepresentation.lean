...
@[simp] theorem realColorJ_sq :
  ...
  funext i
  rcases u i with ⟨x,y⟩
  simp [realColorJ, pairJ, Module.End.mul_apply]
...
theorem realColorAction_commutes_J (A : M3C) :
  ...
  have h := (colorAction A).map_smul Complex.I (colorRealEquiv.symm u)
...
/-- Consolidated Hestenes real-colour representation packet. -/
