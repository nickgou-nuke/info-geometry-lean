...
/-- Zero surface resistance is excluded by the membrane property. -/
...
/-! ## 5. Optional one-dimensional transparency property -/

/--
A property that the transparent/fixed sector is generated by the mirror
diagonal.

This is the extra property needed to say the diagonal is the only transparent
