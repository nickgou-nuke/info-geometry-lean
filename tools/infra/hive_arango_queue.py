...
COLLECTIONS: tuple[CollectionSpec, ...] = (
    ...
    CollectionSpec("hive_symbolic_seeds"),
    CollectionSpec("hive_formulation_variants"),
    CollectionSpec("hive_resonance_clusters"),
    CollectionSpec("hive_pauli_critiques"),
    CollectionSpec("hive_invariants"),
    CollectionSpec("hive_translation_packets"),
...
INDEXES: tuple[IndexSpec, ...] = (
    ...
    IndexSpec("hive_symbolic_seeds", ("lineage_id", "status"), name="symbolic_seed_lineage_status_idx"),
    IndexSpec("hive_formulation_variants", ("lineage_id", "iteration_index"), name="variant_lineage_iter_idx"),
    IndexSpec("hive_resonance_clusters", ("lineage_id", "status"), name="cluster_lineage_status_idx"),
    IndexSpec("hive_pauli_critiques", ("lineage_id", "iteration_index"), name="pauli_lineage_iter_idx"),
    IndexSpec("hive_invariants", ("lineage_id", "status"), name="invariant_lineage_status_idx"),
    IndexSpec("hive_translation_packets", ("lineage_id", "status"), name="translation_lineage_status_idx"),
