...
theorem relation_lift_eq_one (R : BraidThreeGenerators G) :
  ...
  subst r
  simpa [braidThreeArtinRelator, freeSigmaOne, freeSigmaTwo,
    generatorImage, R.artin]
...
theorem toGroupHom_sigmaOne (R : BraidThreeGenerators G) :
    R.toGroupHom sigmaOne = R.sigmaOne := by
  simp [toGroupHom, sigmaOne, generatorImage]

@[simp]
theorem toGroupHom_sigmaTwo (R : BraidThreeGenerators G) :
    R.toGroupHom sigmaTwo = R.sigmaTwo := by
  simp [toGroupHom, sigmaTwo, generatorImage]
...
theorem toGroupHom_unique
    ...
    (φ : BraidGroup3 →* G)
    (h₁ : φ sigmaOne = R.sigmaOne)
    (h₂ : φ sigmaTwo = R.sigmaTwo) :
    φ = R.toGroupHom := by
  apply PresentedGroup.ext
  intro g
  cases g
  · simpa [sigmaOne] using h₁
  · simpa [sigmaTwo] using h₂
...
theorem fibonacciBraidGroupHom_sigmaOne
    ...
    (hs : s ^ 2 = τ)
    (hτ : τ ^ 2 + τ = 1) :
    fibonacciBraidGroupHom q τ s hq_inv hq_pow3 hq5 h_poly hτq hs hτ sigmaOne =
      rLinearEquiv q := by
...
theorem fibonacciBraidGroupHom_sigmaTwo
    ...
    (hs : s ^ 2 = τ)
    (hτ : τ ^ 2 + τ = 1) :
    fibonacciBraidGroupHom q τ s hq_inv hq_pow3 hq5 h_poly hτq hs hτ sigmaTwo =
...
theorem fibonacciBraidGroupHom_sigmaOne_inv
    ...
    fibonacciBraidGroupHom q τ s hq_inv hq_pow3 hq5 h_poly hτq hs hτ sigmaOne⁻¹ =
      rLinearEquiv q⁻¹ := by
  simp [fibonacciBraidGroupHom_sigmaOne, rLinearEquiv_inverse]
...
theorem fibonacciBraidGroupHom_sigmaTwo_inv
    ...
    fibonacciBraidGroupHom q τ s hq_inv hq_pow3 hq5 h_poly hτq hs hτ sigmaTwo⁻¹ =
      bLinearEquiv q⁻¹ τ s hs hτ := by
  simp [fibonacciBraidGroupHom_sigmaTwo,
    bLinearEquiv_inverse]
