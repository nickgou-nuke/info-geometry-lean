...
theorem reflection_sensitive :
    G.full_reflection_sensitive_group_closure_True :=
  G.full_reflection_sensitive_group_closure

/-- The positive grade is the inversion-conjugate of the negative grade. -/
theorem positive_is_inversion_conjugate :
    G.positive_grade_is_inversion_conjugate_True :=
  G.positive_grade_is_inversion_conjugate
...
def toTKKMobiusGroupClosure
  ...
  negative_grade_projective_action := C.negative_grade_projective_action
  zero_grade_structure_action := C.zero_grade_structure_action
  positive_grade_is_inversion_conjugate_True :=
    C.positive_grade_is_inversion_conjugate_True
  positive_grade_is_inversion_conjugate :=
    C.positive_grade_is_inversion_conjugate
  acts_on_projective_null_states := C.acts_on_projective_null_states
  full_reflection_sensitive_group_closure_True :=
    C.full_reflection_sensitive_group_closure_True
  full_reflection_sensitive_group_closure :=
    C.full_reflection_sensitive_group_closure
