...
def distinctCandidateRootFamily : Fin 5 → SplitOctF2Aut
  | 0 => candidateRootFamily 0 true
  | 1 => candidateRootFamily 1 true
  | 2 => candidateRootFamily 2 true
  | 3 => candidateRootFamily 4 true
  | 4 => candidateRootFamily 5 true

theorem distinctCandidateRootFamily_injective :
    Function.Injective distinctCandidateRootFamily := by
  intro i j h
  fin_cases i <;> fin_cases j
  all_goals try rfl
  all_goals
...
def candidateRootSubgroup : Subgroup SplitOctF2Aut :=
