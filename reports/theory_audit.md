...
Generated: 2026-07-24 05:35:12Z
...
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:16:The remaining lemmas and operator-level lift are left as `sorry` markers
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:73:explicit `sorry` placeholders so the missing proofs are visible.
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:117:  sorry
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:125:  sorry
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:135:      = invPairingSocket socket S T := by sorry
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:138:      = logPotentialSocket socket S := by sorry
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:141:      = logPotentialSocket socket T := by sorry
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:161:  sorry
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:169:  sorry
...
lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:113: theorem conj_preserves_log [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:120: theorem conj_preserves_inv_pair [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:128: theorem isDivergence_conj_socket [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:156: theorem opConj_socket_trace_conserved [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Algebra/CuntzTraceSocketConjugation.lean:164: theorem opConj_logPotential_invariant [proof_hole]
  - contains `sorry`/`admit`
