...
print({'stable_page':stable_page,'e2_rank':e2_rank,'survivor_count':survivor,'su3_generators':su3_generators,'su2_generators':su2_generators,'sm_rank':sm_rank,'sm_generators':sm_generators,'cartan':cartan,'ladder_count':len(ladders),'C2_su3_fund':C2_su3_fund,'C2_su3_adj':C2_su3_adj,'C2_su2_doublet':C2_su2_doublet,'charges':charges,'multiplicities':mult,'weyl_count':sum(mult.values()),'color_anomaly':color_anom,'weak_anomaly':weak_anom,'grav_trace':grav_trace,'cubic_trace':cubic_trace,'d2_01':d2(0,1),'s3_order':S3.order(),'edges':6})
