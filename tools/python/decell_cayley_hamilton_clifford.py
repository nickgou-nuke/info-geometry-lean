#!/usr/bin/env python3
"""Clifford-lane exact rational audit for Decell 1965.

Run with the Sage Python environment when plain Python lacks `clifford`:

  /home/goutev/miniforge3/envs/sage/bin/python \
    tools/python/decell_cayley_hamilton_clifford.py
"""
...
def main() -> None:
    ...
    assert n * n == 0
    print("PASS: clifford Cl(1,1) null direction squares to zero")
    ...
    print("DECELL_CAYLEY_HAMILTON_CLIFFORD_CERTIFICATE_OK")
