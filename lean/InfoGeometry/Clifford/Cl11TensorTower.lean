...
/-- The native chiral involution satisfies the real phase sandwich identity
used by the Hestenes--Krein tower. -/
theorem hestenesPhaseBase_chiral_sandwich :
    hestenesPhaseBase * gamma_chiral_base * hestenesPhaseBase = gamma_chiral_base := by
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [hestenesPhaseBase, gamma_chiral_base, gamma_0_base, gamma_1_base,
