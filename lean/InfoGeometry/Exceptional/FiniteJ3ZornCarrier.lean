...
theorem scalar_diagonal_jordan_associator_zero (x y : ScalarDiagonalJ3) :
    scalarDiagonalJordanAssociator x y = (fun _ => 0) := by
  funext i
  dsimp [scalarDiagonalJordanAssociator, scalarDiagonalJordan, scalarDiagonalMul]
  ring
