...
theorem algebraicAnticommutator_self_eq_two_nsmul_momentum
  ...
  unfold algebraicAnticommutator superMomentum
  calc
    Q * Q + Q * Q = Q * Q + Q * Q := rfl
    _ = (2 : ℕ) • (Q * Q) := (two_nsmul (Q * Q)).symm
...
theorem algebraicAnticommutator_self_eq_two_smul_momentum
  ...
  unfold algebraicAnticommutator superMomentum
  exact (two_smul ℂ (Q * Q)).symm

/--
Explicit super-Poincare-style interface.
...
theorem star_cuntzMajoranaSupercharge (n : ℕ) (i : Fin n) :
  ...
  rw [cuntzMajoranaSupercharge, star_add, star_cuntzS, star_cuntzSdag]
  exact add_comm _ _
...
theorem parity_cuntzMajoranaSupercharge (n : ℕ) (i : Fin n) :
  ...
  rw [cuntzMajoranaSupercharge, map_add, parity_S, parity_Sdag, neg_add]
...
/- The momentum generated by a Majorana supercharge is self-adjoint. -/
theorem star_cuntzSuperMomentum (n : ℕ) (i : Fin n) :
    star (cuntzSuperMomentum n i) = cuntzSuperMomentum n i := by
  simp [cuntzSuperMomentum, superMomentum,
    star_cuntzMajoranaSupercharge]
...
theorem parity_cuntzCentralCharge (n : ℕ) :
  ...
  change parity n (1 : CuntzAlg n) = 1
  exact (parity n).map_one
