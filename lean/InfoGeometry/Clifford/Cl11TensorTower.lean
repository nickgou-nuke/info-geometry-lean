...
abbrev gamma_0_base : Matrix (Fin 2) (Fin 2) ℝ := InfoGeometry.Clifford.Cl11Matrix.J1

/-- Real gamma_1 base matrix for the Cl(1,1) atom: Pauli iY. -/
abbrev gamma_1_base : Matrix (Fin 2) (Fin 2) ℝ := InfoGeometry.Clifford.Cl11Matrix.Eminus

/-- Internal real phase axis for the Cl(1,1) atom. -/
abbrev phaseAxisBase : Matrix (Fin 2) (Fin 2) ℝ := gamma_1_base
...
/-- The real modular sheet-sign axis in the local `Cl(1,1)` atom. -/
abbrev modularSignBase : Matrix (Fin 2) (Fin 2) ℝ := gamma_chiral_base

/-- The real sheet-exchange involution in the local `Cl(1,1)` atom. -/
abbrev modularReflectionBase : Matrix (Fin 2) (Fin 2) ℝ := gamma_0_base

/-- The internal real phase axis generated by sheet exchange and sign. -/
def modularPhaseBase : Matrix (Fin 2) (Fin 2) ℝ :=
  modularReflectionBase * modularSignBase

@[simp] theorem modularSignBase_sq :
    modularSignBase * modularSignBase =
      (1 : Matrix (Fin 2) (Fin 2) ℝ) := by
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [modularSignBase, gamma_chiral_base, gamma_0_base,
      gamma_1_base, InfoGeometry.Clifford.Cl11Matrix.J1,
      InfoGeometry.Clifford.Cl11Matrix.Eminus, Matrix.mul_apply,
      Fin.sum_univ_two]

@[simp] theorem modularReflectionBase_sq :
    modularReflectionBase * modularReflectionBase =
      (1 : Matrix (Fin 2) (Fin 2) ℝ) := by
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [modularReflectionBase, gamma_0_base,
      InfoGeometry.Clifford.Cl11Matrix.J1, Matrix.mul_apply,
      Fin.sum_univ_two]

theorem modularReflectionBase_modularSignBase_anticomm :
    modularReflectionBase * modularSignBase =
      -(modularSignBase * modularReflectionBase) := by
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [modularReflectionBase, modularSignBase, gamma_chiral_base,
      gamma_0_base, gamma_1_base, InfoGeometry.Clifford.Cl11Matrix.J1,
      InfoGeometry.Clifford.Cl11Matrix.Eminus, Matrix.mul_apply,
      Fin.sum_univ_two]

theorem modularPhaseBase_eq_gamma_1_base :
    modularPhaseBase = gamma_1_base := by
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [modularPhaseBase, modularReflectionBase, modularSignBase,
      gamma_chiral_base, gamma_0_base, gamma_1_base,
      InfoGeometry.Clifford.Cl11Matrix.J1,
      InfoGeometry.Clifford.Cl11Matrix.Eminus, Matrix.mul_apply,
      Fin.sum_univ_two]

@[simp] theorem modularPhaseBase_sq :
    modularPhaseBase * modularPhaseBase =
      -(1 : Matrix (Fin 2) (Fin 2) ℝ) := by
  rw [modularPhaseBase_eq_gamma_1_base]
