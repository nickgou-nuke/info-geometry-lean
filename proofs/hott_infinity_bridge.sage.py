...
# This file was *autogenerated* from the file hott_infinity_bridge.sage
from sage.all_cmdline import *   # import sage library

_sage_const_8 = Integer(8); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_2 = Integer(2); _sage_const_11 = Integer(11); _sage_const_9 = Integer(9); _sage_const_29 = Integer(29); _sage_const_18 = Integer(18); _sage_const_0 = Integer(0)
heads={
...
repo_count=_sage_const_8 ; mathlib_count=_sage_const_1 ; total_sources=repo_count+mathlib_count
layers={'hott':_sage_const_3 ,'category':_sage_const_4 ,'spectral':_sage_const_1 ,'model':_sage_const_1 }; bridge_layers=sum(layers.values())
...
homotopy_equiv_fields=_sage_const_4 ; exact_couple_maps=_sage_const_3 ; serre_page_start=_sage_const_2 ; serre_stable_page=_sage_const_3 ; quasicategory_simplex_arity=_sage_const_2 ; model_category_classes=_sage_const_3 ; fibred_projection_count=_sage_const_1 
...
G=DiGraph(); G.add_edges([(a,c,e) for a,e,c in edges]); assert G.num_edges()==_sage_const_11 
assert total_sources==_sage_const_9  and bridge_layers==_sage_const_9  and compatibility_edges==_sage_const_11  and rank==_sage_const_29  and signature==_sage_const_18 
