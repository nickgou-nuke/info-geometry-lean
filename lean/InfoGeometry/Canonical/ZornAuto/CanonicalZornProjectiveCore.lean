import InfoGeometry.Canonical.ZornAuto.SplitOctonionBraidSU3
import InfoGeometry.Canonical.ZornAuto.ZornCore
...
The lane-routing extension remains in `CanonicalZornProjectiveTKKBridge`.
