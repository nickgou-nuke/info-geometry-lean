...
The zeta connection is represented by a predicate whose proposition is exactly
vanishing of the reciprocal determinant denominator.
-/
...
theorem sectorTripotentOperator_cube
  ...
  · simp [sectorTripotentOperator, Matrix.mul_apply, Fin.sum_univ_two]
    simpa [pow_succ, pow_two, mul_assoc] using hq
  · simp [sectorTripotentOperator, Matrix.mul_apply, Fin.sum_univ_two]
  · simp [sectorTripotentOperator, Matrix.mul_apply, Fin.sum_univ_two]
  · simp [sectorTripotentOperator, Matrix.mul_apply, Fin.sum_univ_two]
...
theorem souriau_hestenes_krein_synthesis :
  ...
  constructor
  · exact ellipticUnit_sq
  constructor
  · exact hyperbolicUnit_sq
  constructor
  · exact parabolicUnit_sq
  constructor
  · intro β τ
    exact det_ellipticTemperatureOperator β τ
  constructor
  · intro β τ
    exact det_hyperbolicTemperatureOperator β τ
  constructor
  · intro β τ
    exact det_parabolicTemperatureOperator β τ
  constructor
  · intro q hq
    exact sectorTripotentOperator_cube hq
  constructor
  · exact sectorTripotent_positive
  constructor
  · exact sectorTripotent_zero
  constructor
  · exact sectorTripotent_negative
  · intro z
    exact gradedSupertracePole_iff_denominator_zero z
