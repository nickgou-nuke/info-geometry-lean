...
/-- 
  The Metriplectic Liouville Operator L = J + M.
  J is the skew-symmetric (Hamiltonian) conformal flow.
  M is the symmetric (Dissipative) free-energy gradient.
-/
...
/--
  The Free Energy parameter fixed by the geometry of the Pin(5,5) Orbifold.
  The entropic dissipation rate γ is locked to 1/2 by the topological cut-off.
-/
