...
/--
Minimal real Krein-style quadratic carrier.

This is not a complex Hilbert space. It is a real module equipped with an
indefinite quadratic form.
-/
class KreinProjectiveCarrier
    (V : Type*) [AddCommGroup V] [Module ℝ V] where
  form : QuadraticForm ℝ V
  exists_pos : ∃ v : V, 0 < form v
  exists_neg : ∃ v : V, form v < 0
