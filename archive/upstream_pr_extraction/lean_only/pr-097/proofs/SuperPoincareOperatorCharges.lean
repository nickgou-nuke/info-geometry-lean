...
#check central_charge_commutes_with_momentum
#check central_charge_commutes_with_lorentz
#check central_charge_commutes_with_supercharge
#check chiral_dirac_square_eq_momentum_operator
#check chiral_dirac_square_eq_given_momentum
#check operator_central_charge_from_anticommutator
#check central_charge_commutes_with_defining_anticommutator
