...
This bundle is the operational handover set for the DGX Spark rollout with:
...
- [POLICY.md](POLICY.md) — authority order, lane model, entry/exit criteria
- [PROMPTS.md](PROMPTS.md) — two system prompts (Exploration/Stabilization and Closure/Gating)
- [PERSONAS.md](PERSONAS.md) — role boundaries and conflict protocol
- [ACTIVATION_CHECKLIST.md](ACTIVATION_CHECKLIST.md) — day-0 activation and daily run sequence

## Canonical Sources

These package files are mirrored from:
