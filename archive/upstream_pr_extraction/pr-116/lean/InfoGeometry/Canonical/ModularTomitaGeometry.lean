...
for downstream imports, but no legacy property-packed declarations are kept here.
The module is now routed through the Hestenes/Krein interface: real
endomorphisms, Krein symmetry, rotor flow, commutator derivations, and checked
Fredholm/core readouts.
-/
