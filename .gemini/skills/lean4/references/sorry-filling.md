...
**Solution:** Enumerate sorries, add each to a FIXME list, and work on ONE at a time.

**Step 1: Enumerate**
```
List all sorry's in the project, then add each as a single item to the FIXME list.
```
...
**Step 4: Repeat**
Continue with the next sorry in the FIXME list.
...
- Document as FIXME with strategy
