...
# The old class pattern (uses socratic_clawbot)
...
# Count occurrences
count = content.count('class SocraticVerifier:\n    """Socratic verifier')
print(f"Found {content.count('class SocraticVerifier:\\n    \"\"\"Socratic verifier')} occurrences")
...
old = content.count('class SocraticVerifier:\n    """Socratic verifier')
print(f"Found {content.count('class SocraticVerifier:\\n    \"\"\"Socratic verifier')} occurrences")

# Use regex to replace all occurrences
new_content = re.sub(
    r'class SocraticVerifier:.*?(?=\nclass \w+:)',
    new_class,
    content,
    flags=re.DOTALL
)
