...
theorem matrixGrade_mul (x y : Z2Grade) :
  ...
  all_goals
    ...
    fin_cases i <;> fin_cases j <;>
      apply Complex.ext <;>
      norm_num [matrixGrade, coreGrade, matrixCochain, matrixExponent,
        complexDouble, Eplus, Eminus, J1, signUnit,
        Matrix.mul_apply, Fin.sum_univ_two, Pi.add_apply,
...
theorem splitGrade_mul (x y : Z2Grade) :
  ...
  all_goals
    norm_num [splitGrade, splitDouble_coordinates, coreGrade, splitCochain,
      splitExponent, Eplus, Eminus, J1, signUnit,
      ZornMatrix.mul, ZornMatrix.smul, Vec3.dot, Vec3.cross,
      Vec3.add, Vec3.sub, Vec3.smul, Pi.add_apply,
      hx0, hx1, hx2, hy0, hy1, hy2]
...
theorem splitCochain_associator_basis :
  ...
  norm_num [associatorParity, signUnit]
