...
def rangeProjection (i : Fin 3) : CuntzAlg 3 :=
  cuntzS 3 i * star (cuntzS 3 i)

def Q12 : CuntzAlg 3 := cuntzS 3 (0 : Fin 3) * star (cuntzS 3 (1 : Fin 3))
def Q21 : CuntzAlg 3 := cuntzS 3 (1 : Fin 3) * star (cuntzS 3 (0 : Fin 3))
def Q23 : CuntzAlg 3 := cuntzS 3 (1 : Fin 3) * star (cuntzS 3 (2 : Fin 3))
def Q32 : CuntzAlg 3 := cuntzS 3 (2 : Fin 3) * star (cuntzS 3 (1 : Fin 3))
def Q31 : CuntzAlg 3 := cuntzS 3 (2 : Fin 3) * star (cuntzS 3 (0 : Fin 3))
def Q13 : CuntzAlg 3 := cuntzS 3 (0 : Fin 3) * star (cuntzS 3 (2 : Fin 3))

def Lambda3 : CuntzAlg 3 := rangeProjection (0 : Fin 3) - rangeProjection (1 : Fin 3)

def Lambda8 : CuntzAlg 3 :=
  rangeProjection (0 : Fin 3) + rangeProjection (1 : Fin 3) - 2 * rangeProjection (2 : Fin 3)

def lieBracket (x y : CuntzAlg 3) : CuntzAlg 3 := x * y - y * x
