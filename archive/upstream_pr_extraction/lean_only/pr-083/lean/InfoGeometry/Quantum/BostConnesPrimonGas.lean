...
/-- 🏆 GRAND CAPSTONE: Complete formal verification of the Boson-Fermion duality,
    finite-stage primon product cancellation, low-temperature bounds,
    and Boltzmann log-energy weights. -/
theorem grand_bost_connes_moebius_kms_synthesis
  ...
  ⟨bosonic_fermionic_factor_duality p hp β (by linarith),
