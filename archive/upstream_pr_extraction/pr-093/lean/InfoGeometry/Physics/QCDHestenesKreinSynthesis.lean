...
/-- Real-colour/Fock parallel packet.  The two square-minus-one operators live on
separate theorem-owned real carriers. -/
...
/-- Existing real Zorn/Furey injection packaged next to the internal-complex
colour lane.  This theorem deliberately does not assert `Phi J_Z = J_F Phi`. -/
