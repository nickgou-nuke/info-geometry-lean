...
/-!
# Nuclear Klein topology umbrella

This declaration-free import surface exposes the theorem-bearing global
parameter-space layer built on the existing finite Klein quotient:

* Klein-equivariant operator-valued Soloviev fields on the finite torus cover;
* exact internal/external parity realization of one base glide;
...
end InfoGeometry.Physics.NuclearKleinTopologyAll
