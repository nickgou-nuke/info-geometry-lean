...
abbrev ProjectiveClosure :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.ProjectiveClosure

@[simp] theorem mem_projectiveClosure (n : ℤ) :
    n ∈ ProjectiveClosure ↔ n = -1 ∨ n = 0 ∨ n = 1 :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.mem_projectiveClosure n

abbrev anomalyFactor :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.anomalyFactor

@[simp] theorem anomalyFactor_neg_one : anomalyFactor (-1) = 0 :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.anomalyFactor_neg_one

@[simp] theorem anomalyFactor_zero : anomalyFactor 0 = 0 :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.anomalyFactor_zero

@[simp] theorem anomalyFactor_one : anomalyFactor 1 = 0 :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.anomalyFactor_one

theorem anomalyFactor_eq_zero_of_mem_projective {m : ℤ} (hm : m ∈ ProjectiveClosure) :
    anomalyFactor m = 0 :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.anomalyFactor_eq_zero_of_mem_projective hm
...
theorem virasoroCocycle_lgen_left_projective_zero (m n : ℤ) (hm : m ∈ ProjectiveClosure) :
  ...
  InfoGeometry.Algebra.WittProjectiveClosureHonest.virasoroCocycle_lgen_left_projective_zero
    (𝕜 := 𝕜) m n hm

theorem virasoroCocycle_lgen_right_projective_zero (m n : ℤ) (hn : n ∈ ProjectiveClosure) :
    virasoroCocycle 𝕜 (lgen 𝕜 m) (lgen 𝕜 n) = 0 :=
  InfoGeometry.Algebra.WittProjectiveClosureHonest.virasoroCocycle_lgen_right_projective_zero
    (𝕜 := 𝕜) m n hn
...
theorem projective_bracket_eq_witt (m n : ℤ)
  ...
  InfoGeometry.Algebra.WittProjectiveClosureHonest.projective_bracket_eq_witt
    (𝕜 := 𝕜) m n _hm _hn
...
theorem projective_sum_mem_of_bracket_coeff_ne_zero
  ...
  InfoGeometry.Algebra.WittProjectiveClosureHonest.projective_sum_mem_of_bracket_coeff_ne_zero
    (𝕜 := 𝕜) hm hn hcoeff
