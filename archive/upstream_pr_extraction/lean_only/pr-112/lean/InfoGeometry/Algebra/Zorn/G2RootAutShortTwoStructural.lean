...
theorem pcWord_shortTwoPCExp_eq_pc6Aut :
    G2TwoSylowSubgroup.pcWord shortTwoPCExp =
...
theorem c_conj_pc4Aut_eq_pc6Aut :
    c * G2TwoSylowPCAutomorphisms.pc4Aut * c⁻¹ =
      G2TwoSylowPCAutomorphisms.pc6Aut := by
  apply autMatrix_injective
  calc
    autMatrix (c * pc4Aut * c⁻¹) = C5 := autMatrix_c_conj_pc4Aut_eq_C5
    _ = autMatrix G2TwoSylowPCAutomorphisms.pc6Aut := autMatrix_pc6Aut_eq_C5.symm
...
theorem rootAut_short_two_eq_pcWord_structural :
  ...
  simpa [shortTwoPCExp, shortTwoCorrectedPCExp] using
