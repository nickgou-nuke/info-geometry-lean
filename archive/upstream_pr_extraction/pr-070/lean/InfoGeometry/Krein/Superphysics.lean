...
abbrev Supercharge :=
  {Q : DoubledSpace E →L[ℝ] DoubledSpace E // isOdd Q}

abbrev Supercharge.Q (S : Supercharge (E := E)) :
    DoubledSpace E →L[ℝ] DoubledSpace E := S.1

abbrev Supercharge.odd (S : Supercharge (E := E)) : isOdd S.Q := S.2
...
noncomputable def epsilonSupercharge : Supercharge (E := E) :=
  ⟨spectral_epsilon, spectral_epsilon_isOdd⟩
...
noncomputable def complex_iSupercharge : Supercharge (E := E) :=
  ⟨complex_i, complex_i_isOdd⟩
