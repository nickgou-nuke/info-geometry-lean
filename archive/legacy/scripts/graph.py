#!/usr/bin/env python3
"""Legacy/compatibility graph consumer for older InfoGeometry declaration exports.
...
class ProjectGraph:
    """Compatibility NetworkX wrapper over older declaration graph exports.

    This class is still useful for ad hoc inspection, but it is not the
    authoritative causal-order layer of the repository.
    """
