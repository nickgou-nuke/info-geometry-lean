...
content = open('/home/goutev/repos/info-geometry-lean/sandbox/MobiusGeometry.lean').read()

# Locate the beginning of the block I inserted earlier
start_idx = content.find("/-- Extended cross-ratio handling infinity on the Riemann sphere. -/")
end_idx = content.find("/-- Four distinct points lie on a generalized circle if and only if their cross-ratio is strictly real. -/")

new_content = """/-- Extended cross-ratio handling infinity on the Riemann sphere. -/
...
with open('/home/goutev/repos/info-geometry-lean/sandbox/MobiusGeometry.lean', 'w') as f:
    f.write(content)
