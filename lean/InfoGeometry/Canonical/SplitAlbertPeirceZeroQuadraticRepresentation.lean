...
theorem smul_preserves_peirceZero
    ...
    InPeirceZero (r • X) := by
  rcases hX with ⟨h1, ha, hc⟩
  simp [InPeirceZero, H3Zorn.smul_readback, h1, ha, hc]
...
theorem sub_preserves_peirceZero
  ...
  simp [InPeirceZero, H3Zorn.sub_readback, hX1, hXa, hXc, hY1, hYa, hYc]
...
theorem quadraticJordanOp_eq_U (y x : H3) :
  ...
  rw [quadraticJordanOp]
  rw [candidateJordanMul]
  rw [candidateJordanMul_smul_right, candidateJordanMul_smul_left]
  rw [candidateJordanMul]
