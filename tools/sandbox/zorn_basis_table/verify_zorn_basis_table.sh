...
M2 --script zorn_basis_table_dmodules.m2
/home/goutev/.opam/rocq-9.2/bin/coqc coq/ZornBasisTable.v
/usr/local/bin/isabelle build -D isabelle
printf 'ZORN_BASIS_TABLE_MULTIENGINE_OK entries=64 engines=lean,sympy,sage,gap,singular,macaulay2,macaulay2-dmodules,coq,isabelle\n'
