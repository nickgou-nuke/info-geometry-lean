...
Generated: 2026-06-27 15:07:03Z
...
lean/InfoGeometry/Spectral/Cohomology/Serre.lean:26:    SerreSpectralSequence B F E := by sorry
lean/InfoGeometry/Spectral/Cohomology/Serre.lean:34:    GysinSequence B E := by sorry
lean/InfoGeometry/Spectral/Cohomology/Serre.lean:37:def projective_space_cohomology (n : ℕ) : AddCommGroup := by sorry
lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:44:  by sorry
lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:50:    gysinSequence HB f e A (m, 0) ≃ₗ[ℤ] (uoH^(m+n+1)[B, A]) := by sorry
lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:54:    gysinSequence HB f e A (m, 1) ≃ₗ[ℤ] (uoH^(m-1)[B, A]) := by sorry
lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:58:    gysinSequence HB f e A (m, 2) ≃ₗ[ℤ] (uoH^n+m[E, A]) := by sorry
lean/InfoGeometry/Spectral/Cohomology/Basic.lean:33:  by sorry
lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:14:def K_Z_2_cohomology (n : ℤ) : AddCommGroup := by sorry
lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:17:def K_Z_2_cohomology_with_coeffs (G : AddCommGroup) (n : ℤ) : AddCommGroup := by sorry
lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:25:def K_Z_2_cohomology_ring : CohomologyRing ℤ := by sorry
lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:28:def K_Z_2_cup_product (n m : ℤ) : AddCommGroup := by sorry
lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:31:def real_projective_space_cohomology (n : ℕ) : AddCommGroup := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:96:    sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:176:    (B (Decat G) →* B H) ≃* (B G →* B (Disc H)) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:182:          (PpcomposeLeft h ∘* PpcomposeRight g) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:184:def DecatDisc {n k : ℕ} (G : GType n k) : Decat (Disc G) = G := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:188:    (B (Deloop G) →* B H) ≃* (B G →* B (Loop H)) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:194:          (PpcomposeLeft (ConnectFunctor k h) ∘* PpcomposeRight g) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:196:def LoopDeloop {n k : ℕ} (G : GType n (k + 1)) : Loop (Deloop G) = G := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:200:    (B (Stabilize G) →* B H) ≃* (B G →* B (Forget H)) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:206:          (PpcomposeLeft (LoopSpace.map h) ∘* PpcomposeRight g) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:209:    B (Stabilize (Forget G)) ≃* B G := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:211:def StabilizeForget' {n k : ℕ} (H : k ≥ n + 1) (G : GType n;k+1)GType) : B (Stabilize (Forget G)) ≃* B G := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:213:def Stabilization {n k : ℕ} (H : k ≥ n + 2) : IsEquiv (@Stabilize n k) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:217:def IsTruncGTypeHom {n k : ℕ} (G H : GType n k) : IsTrunc n (GTypeHom G H) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:219:def IsSetGTypeHom {k : ℕ} (G H : GType 0 k) : IsSet (GTypeHom G H) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:221:def IsTruncGType {n k : ℕ} : IsTrunc (n + 1) (GType n k) := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:225:def CGType (k : ℕ) : Precategory := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:229:def CGTypeEquivalenceCType (k : ℕ) : CGType k ≃c CType*[k - 1] := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:231:def CGTypeEquivalenceGrp : CGType.{u} 1 ≃c Grp.{u} := by sorry
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:233:def CGTypeEquivalenceAbGrp (k : ℕ) : CGType.{u} (k + 2) ≃c AbGrp.{u} := by sorry
lean/InfoGeometry/Eval/ClosureDebtTest.lean:15:/-! ## Pattern 1: _True : Prop := by sorry -/
lean/InfoGeometry/Eval/ClosureDebtTest.lean:19:    sorry
lean/InfoGeometry/Eval/ClosureDebtTest.lean:29:    sorry
lean/InfoGeometry/Eval/ClosureDebtTest.lean:35:    sorry
lean/InfoGeometry/Eval/ClosureDebtTest.lean:41:    sorry
lean/InfoGeometry/Eval/ClosureDebtTest.lean:47:    sorry
lean/InfoGeometry/Eval/ClosureDebtTest.lean:53:    sorry
...
lean/InfoGeometry/Meta/OwnerTarget.lean:30:  sorry -- obligation: fill in the proof
...
lean/InfoGeometry/Algebra/CuntzFockRepresentation.lean:173:| `BostConnesAnalytic.lean` | 7+1 | Boltzmann limits, partition function (+1 ground state calculus sorry) |
lean/InfoGeometry/Algebra/NoFaithfulAssociativeModel.lean:17:No wrappers. No structures. No `sorry`.
lean/InfoGeometry/Algebra/CuntzRecursiveFermionSystem.lean:216:/-! ## Wedge Actions (sorry-free) -/
...
lean/InfoGeometry/Canonical/LeeYangAsanoDigest.lean:909:`Analysis.AsanoContractionNative` (no `sorry`).
lean/InfoGeometry/Canonical/LeeYangAsanoDigest.lean:1090:`sorry`.
...
lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:103:        sorry)  -- Fix: use different sigma matrices
lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:152:  sorry  -- Standard result
lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:178:  sorry  -- Uses universal property of tensor product
lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:182:  sorry  -- Standard structural result for Clifford algebras
lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:204:      sorry  -- Recursive definition using tensor product
lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:212:  sorry  -- Uses Artin-Wedderburn
lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:230:    sorry  -- Requires block matrix extraction
lean/InfoGeometry/Clifford/SpinorRep_Kronecker.lean:92:  sorry  -- Requires: Algebra.TensorProduct.lift + verify algebra hom properties
lean/InfoGeometry/Clifford/SpinorRep_Kronecker.lean:148:        sorry  -- Needs kroneckerAlgEquiv
lean/InfoGeometry/Clifford/SpinorRep_Kronecker.lean:161:      sorry
lean/InfoGeometry/Clifford/SpinorRep_Kronecker.lean:174:  sorry  -- Follows from naturality of tensor product construction
lean/InfoGeometry/Clifford/SpinorRep_Kronecker.lean:184:    sorry
lean/InfoGeometry/Clifford/SpinorRep_Final.lean:115:        sorry
lean/InfoGeometry/Clifford/SpinorRep_Final.lean:128:      sorry
lean/InfoGeometry/Clifford/SpinorRep_Final.lean:137:    sorry  -- Requires block diagonal construction
lean/InfoGeometry/Clifford/SpinorRep_Final.lean:138:    := sorry
lean/InfoGeometry/Clifford/SpinorRep_Final.lean:146:  sorry
lean/InfoGeometry/Clifford/SPINOR_REPR_COMPLETE.lean:34:- Does NOT use `sorry` to fake proofs
lean/InfoGeometry/Clifford/SPINOR_REPR_COMPLETE.lean:75:The "sorry" markers honestly reflect work that remains.
lean/InfoGeometry/Clifford/SPINOR_REPR_COMPLETE.lean:134:  sorry  -- Awaiting tensor product development (M ⊗ N ≃ K)
lean/InfoGeometry/Clifford/CliffordInjectivity.lean:50:## Why We Accept This `sorry`
lean/InfoGeometry/Clifford/CliffordInjectivity.lean:101:  sorry  -- Awaiting full spinor rep formalization
lean/InfoGeometry/Clifford/CliffordInjectivity.lean:144:  sorry  -- Needs substantial representation theory development
lean/InfoGeometry/Clifford/SpinorRep_COMPLETE.lean:178:      sorry  -- Requires: incl corresponds to id ⊗ 1 under prodEquiv
lean/InfoGeometry/Clifford/SpinorRep_COMPLETE.lean:181:    sorry
lean/InfoGeometry/Clifford/SpinorRep_COMPLETE.lean:193:  sorry
lean/InfoGeometry/Clifford/ConformalSpinorBridge/SuperLieRingInstance.lean:20:- All proofs are real — no `trivial`, `axiom`, or `sorry` placeholders
lean/InfoGeometry/Clifford/SpinorRep.lean:128:  sorry  -- Requires CliffordAlgebra.sum_iso_tensor_product
lean/InfoGeometry/Clifford/SpinorRep.lean:198:      sorry  -- Requires detailed tensor calculation
lean/InfoGeometry/Clifford/SpinorRepMinimal.lean:68:      sorry  -- Requires explicit tensor construction
lean/InfoGeometry/Clifford/SpinorRepMinimal.lean:73:  | succ n ih => sorry  -- Needs tensor product development
lean/InfoGeometry/Clifford/SpinorRepMinimal.lean:82:  sorry  -- Requires block matrix API
...
lean/InfoGeometry/Clifford/SpinorRep_STRATEGY.lean:97:  sorry  -- Awaiting compilation of main file
lean/InfoGeometry/Clifford/SORRIES/CliffordInjectivity.lean:109:### Why We Accept This `sorry`
lean/InfoGeometry/Clifford/SORRIES/CliffordInjectivity.lean:132:3. Mark theorems with `sorry` but know they're true
lean/InfoGeometry/Clifford/SORRIES/CliffordInjectivity.lean:173:  sorry  -- See KNOWN_RESULTS.md for references and computational evidence
lean/InfoGeometry/Clifford/SpinorRep_FULL.lean:131:  sorry  -- Requires unfolding prodEquiv definition
lean/InfoGeometry/Clifford/SpinorRep_FULL.lean:153:  sorry  -- Uses: kroneckerAlgEquiv_apply, kronecker_one_right
...
lean/InfoGeometry/Canonical/ConformalSubalgebraDebt.lean:8:`sorry` tokens from the conformal subalgebra without introducing new wrappers.
...
lean/InfoGeometry/JordanDecomposition.lean:14:3. `jordanBasis`: algorithmic construction (1 sorry — quotient basis picking)
```

- Total placeholder occurrences in canonical tree: 188

## Axiom declarations

```text
lean/InfoGeometry/Algebra/HessianThermodynamicManifold.lean:156:   axiom, equivalent to positive-definiteness of the trace form).
```
...
[audit] Files with namespace InfoGeometry*: 3486
[audit] Files missing namespace InfoGeometry*: 325
...
./lean/InfoGeometry/External/Auto/test.lean
...
./lean/InfoGeometry/External/Automath/Omega/Zeta/XiHilbertPolyaCMV.lean
./lean/InfoGeometry/External/Automath/Omega/Zeta/XiHilbertPolyaJacobi.lean
./lean/InfoGeometry/External/Automath/Omega/Zeta/XiHilbertPolyaNinefoldEquivalenceDoubledSelfadjointCompression.lean
...
./lean/InfoGeometry/Instanton/VortexPartition.lean
...
./lean/InfoGeometry/Sandbox/ChernIsomorphismSandbox.lean
...
./lean/InfoGeometry/Spectral/HigherGroups/Basic.lean
...
./lean/InfoGeometry/Audit.lean :: 32:namespace Audit
...
./lean/InfoGeometry/Canonical/ConformalSubalgebraDebt.lean :: 19:namespace ConformalSubalgebra
./lean/InfoGeometry/Canonical/ConnesRadonNikodymCocycle.lean :: 48:namespace ConnesCocycle
./lean/InfoGeometry/Canonical/CyclicCocycleCantor.lean :: 20:namespace CyclicCocycleCantor
...
./lean/InfoGeometry/E8/E8TrialityThermalProtection.lean :: 36:namespace E8Triality
...
./lean/InfoGeometry/External/Automath/Omega/Zeta/XiHilbertPolyaCMV.lean :: 3:namespace Omega.Zeta
./lean/InfoGeometry/External/Automath/Omega/Zeta/XiHilbertPolyaJacobi.lean :: 3:namespace Omega.Zeta
./lean/InfoGeometry/External/Automath/Omega/Zeta/XiHilbertPolyaNinefoldEquivalenceDoubledSelfadjointCompression.lean :: 1:namespace Omega.Zeta
...
./lean/InfoGeometry/External/Virasoro/ChiralProduct.lean :: 25:namespace VirasoroProject
...
./lean/InfoGeometry/JordanDecomposition.lean :: 25:namespace JordanDecomposition
...
./lean/InfoGeometry/Monster/MonsterMoonshineThermal.lean :: 30:namespace MonsterMoonshine
...
./lean/InfoGeometry/Physics/ChiralityPseudoscalarCuntz.lean :: 13:namespace ChiralityPseudoscalar
...
=== Namespace prefix histogram (first namespace line per file) ===
   3514 InfoGeometry
     ...
     10 SymmetricLieAlgebra
      ...
      4 InverseKernel
      4 DeBruijnPayload
      4 ConformalPositivePartitionWitness
...
Forbidden quarantined import: InfoGeometry.Canonical.GrandSynthesis in lean/InfoGeometry/CoverageClosure.lean:190
Forbidden quarantined import: InfoGeometry.Canonical.GrandUnificationBlueprint in lean/InfoGeometry/CoverageClosure.lean:191
Forbidden quarantined import: InfoGeometry.Canonical.HolographicEmergence in lean/InfoGeometry/CoverageClosure.lean:200
Forbidden quarantined import: InfoGeometry.Canonical.PositiveRayProjectiveBridge in lean/InfoGeometry/CoverageClosure.lean:245
Forbidden quarantined import: InfoGeometry.Canonical.SUSYBayes in lean/InfoGeometry/CoverageClosure.lean:266
...
```text
wrote /tmp/proof_gap_report.md (130 gaps)
...
```text
wrote /tmp/proof_gap_report.review.md (130 gaps)
...
lean/InfoGeometry/Algebra/CubicJordanOs.lean:124: lemma smul_z [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Algebra/CubicJordanOs.lean:126: lemma subZ_zeroZ [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Algebra/CubicJordanOs.lean:129: lemma conjZ_zeroZ [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Algebra/CubicJordanOs.lean:137: lemma detZ_zeroZ_cast [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Algebra/CuntzFockRepresentation.lean:117: theorem gnSInner_matrix_unit_conj_symm [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Algebra/JordanCayleyInversionOsQ.lean:43: theorem det_eq_quadratic [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Algebra/ZornVectorMatrix.lean:98: theorem conj_trace_identity [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Algebra/ZornVectorMatrix.lean:101: theorem conj_norm_identity_left [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Analytic/LogSumExp.lean:317: lemma logSumExp_deriv_eq_mean [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/BostConnesSystem.lean:168: theorem totalPrimeFactors_prime [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/BostConnesSystem.lean:189: theorem liouville_one [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/CantorDiracOperator.lean:129: theorem majorana_anticomm_zero_of_ne [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/CastroThetaScalingBridge.lean:100: theorem kronecker_self [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/CastroThetaScalingBridge.lean:104: theorem kronecker_of_ne [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/MobiusFermionBosonization.lean:93: theorem exteriorProduct_eq_some_union_of_disjoint [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/MobiusFermionBosonization.lean:101: theorem exteriorProduct_eq_none_of_not_disjoint [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/PrimeDistributionLaw.lean:241: theorem chebyshev_psi_holds [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/PrimeExteriorRepresentation.lean:121: theorem Gamma_eq_negOne_pow_fermionNumber [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeGrandCanonicalEnsemble.lean:179: theorem gibbsWeight_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeGrandCanonicalSouriauWeights.lean:80: theorem complexBosonGrandPartition_eq_prod_inv [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeGrandCanonicalSouriauWeights.lean:109: theorem grandPotential_eq_neg_inv_beta_mul_massieu [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeGrandCanonicalSouriauWeights.lean:146: theorem finitePrimeBosonGrandPartition_eq_prod [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeMajoranaBitFlip.lean:72: theorem card_majoranaFlip_of_not_mem [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/PrimeParafermionGrandCanonicalClock.lean:149: theorem finiteParafermionLocalFactor_three [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeParafermionGrandCanonicalClock.lean:198: theorem finiteGrandParafermion3Partition_empty [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeParafermionGrandCanonicalClock.lean:222: theorem grandComplexPrimeWeight_one [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeParafermionGrandCanonicalClock.lean:272: theorem grandCanonicalSurprisal_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeParafermionGrandCanonicalClock.lean:288: theorem shannonEntropyFromSurprisal_eq_expectedSurprisal [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeSpinorSquareRootBoost.lean:68: theorem diracCoefficient_sq_eq_energyFromCoefficient [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeSpinorWittenIndex.lean:143: theorem majoranaBlockPfaffian_sq_eq_determinant [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeSuperalgebra.lean:233: theorem finiteComplexBosonPartition_empty [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeSupertraceFinite.lean:94: theorem paritySign_empty [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeWeylDenominatorBridge.lean:50: theorem finitePrimeWeylDenominator_eq_signedFermionPartition [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimeWeylDenominatorBridge.lean:59: theorem finitePrimeBosonicInverseDenominator_eq_bosonPartition [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/PrimonMajoranaWittenCharacter.lean:74: theorem finiteWittenCharacter_empty [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimonMajoranaWittenCharacter.lean:78: theorem finiteWittenCharacter_insert [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimonMajoranaWittenCharacter.lean:251: theorem pfaffian_majoranaPfaffianBlock [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimonSupergradedGasAlgebra.lean:123: theorem finitePrimonWittenIndex_cancel [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimonThermodynamics.lean:45: theorem bosonPartition_singleton [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimonThermodynamics.lean:49: theorem fermionPartition_singleton [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/PrimonThermodynamics.lean:54: theorem bosonPartition_union [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/RamanujanOddZeta.lean:111: theorem reflectedModularWeight_eq_sign_factored [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/RamanujanOddZeta.lean:121: theorem ramanujanOddZetaLHS_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/RiemannZetaEquivalences.lean:166: theorem eulerProductZeta_eq_riemannZeta [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/SelfConcordantZetaBarrier.lean:104: theorem bregman_self [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/SplitCliffordRealization.lean:59: theorem euler_anticommutes_J [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/TrifactorZetaBridge.lean:84: theorem centeredXi_zero_reflected [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:147: theorem chartCriticalLine_iff_complexCriticalLine [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:164: theorem centeredSigma_chartConjugation [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:503: theorem criticalTangent_idempotent [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:508: theorem criticalNormal_idempotent [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:513: theorem criticalNormal_after_tangent [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:518: theorem criticalTangent_after_normal [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:534: theorem conjugation_preserves_flatQuadratic [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:539: theorem functionalDual_preserves_flatQuadratic [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:544: theorem criticalMirror_preserves_flatQuadratic [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:564: theorem invariantPotential_opposite_normal_values [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:605: theorem normalQuadraticPotential_criticalMirror [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:610: theorem normalQuadraticPotential_eq_zero_iff [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaCoordinateSymmetry.lean:619: theorem heightTranslation_preserves_u [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/ZetaDihedral.lean:46: theorem tau_involution [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaDihedral.lean:50: theorem sigma_involution [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaDihedral.lean:54: theorem gamma_involution [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaDihedral.lean:58: theorem tau_sigma_commute [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/ZetaPrimeFluctuationBridge.lean:64: theorem normalProjection_u [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaPrimeFluctuationBridge.lean:68: theorem normalProjection_v [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaPrimeFluctuationBridge.lean:72: theorem tangentProjection_u [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaPrimeFluctuationBridge.lean:76: theorem tangentProjection_v [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaSouriauThermodynamics.lean:148: theorem complexBosonGrandPartition_eq_prod_inv [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaSouriauThermodynamics.lean:225: theorem grandPotential_eq_neg_inv_beta_mul_massieu [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaSymmetryAdaptedDefinitions.lean:120: theorem centeredDirichletMode_conjugation [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaSymmetryAdaptedDefinitions.lean:126: theorem centeredDirichletMode_functionalDual [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaSymmetryAdaptedDefinitions.lean:132: theorem centeredDirichletMode_criticalMirror [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaSymmetryAdaptedDefinitions.lean:161: theorem finiteDirichletReadout_insert [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Arithmetic/ZetaTraceVielbeinSpecialization.lean:65: theorem primeLocalEffectiveAction_def [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaTraceVielbeinSpecialization.lean:136: theorem canonicalPrimeVielbein_eulerSupervolume [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaTraceVielbeinSpecialization.lean:142: theorem canonicalPrimeVielbein_traceLogSupervolume_eq_riemannZeta [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/ZetaTraceVielbeinSpecialization.lean:148: theorem canonicalPrimeVielbein_eulerSupervolume_eq_riemannZeta [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/BayesianMarkovChain.lean:192: theorem iterateState_succ [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/BerryHolonomy.lean:26: theorem informationBerryPhase_eq_loopLength_mul_chiralAnomalyIndex [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BerryHolonomy.lean:32: theorem informationBerryPhase_eq_loopLength_mul_epsilon_mul_rank [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BerryHolonomy.lean:42: theorem informationBerryPhase_ne_zero_of_loopLength_ne_zero_of_chiralAnomalyIndex_ne_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/BostConnesKMS.lean:90: theorem S_mul [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BostConnesKMS.lean:95: theorem S_isometry [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BostConnesKMS.lean:107: theorem S_orthogonal [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BostConnesKMS.lean:184: theorem kmsProjectionWeight_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BostConnesKMS.lean:199: theorem kmsProjectionReadout_self [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BostConnesKMS.lean:241: theorem kms_evaluation_on_diagonal_projection [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/BostConnesKMS.lean:247: theorem kms_evaluation_on_off_diagonal_projection [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/CantorSplitNullBridge.lean:143: theorem addressNullGenerator_child_ne_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/CantorSplitNullBridge.lean:148: theorem addressNullGenerator_child_detZ_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/CantorSplitNullBridge.lean:153: theorem addressNullGenerator_child_sq_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/ChiralCausalConeFlow.lean:67: theorem weyl_trace_scaling [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/ChiralNullSpaceBridge.lean:49: theorem excitedStateSector_eq_orthogonal [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/ChiralNullSpaceBridge.lean:53: theorem regulatedHeatKernel_eq_subtract_one [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/CliffordEquiv.lean:346: theorem peirceLadder_J_eq_cl11_generator [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/CliffordO55ProjectiveReconciliation.lean:51: theorem cl55_window_is_stage_five [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/CliffordO55ProjectiveReconciliation.lean:72: theorem cl55_tensor_step_eq_owner [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/CuntzTomitaTakesaki.lean:163: theorem DeltaHalf_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/CuntzTomitaTakesaki.lean:168: theorem modularJ_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/CyclicCocycleCantor.lean:116: theorem cyclicCocycle_cocycleIdentity [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/DiracSouriauOperator.lean:78: theorem toMatrix_eq_fromBlocks [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/DrazinSupercharge.lean:436: theorem supercharge_is_oddK [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/FiniteFibonacciMonodromyInterface.lean:55: theorem braidWordAction_cons [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/FiniteFibonacciMonodromyInterface.lean:98: theorem electronBlindBraidAction_independent_of_r [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/FiniteFibonacciQubitNoLeakage.lean:130: theorem twoQubitNoLeakageAction_nc [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/GeometricStokes.lean:74: theorem stokesBivectorResidue_eq_two_pi_smul [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/GrandCanonicalExperts.lean:371: lemma diracAction_add_right [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/HadjiivanovMonodromyProjection.lean:57: theorem braid_hecke_relation [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/HadjiivanovMonodromyProjection.lean:154: theorem virasoro_L0_trace [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/HartwigSouriauFrameDrazin.lean:103: theorem principalIdempotent_eq_drazin_complement [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/InductiveOperatorTaylorClosure.lean:42: theorem operatorTaylorPrefix_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/JordanChevalleyPolynomialBridge.lean:66: theorem nilpotentPart_commute [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/MoebiusHurwitzDuality.lean:66: theorem fine_structure_mersenne_decomposition [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/MoebiusHurwitzDuality.lean:76: theorem m2_equals_su3_fundamental_dim [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/MoebiusHurwitzDuality.lean:86: theorem m3_equals_octonion_imaginary_dim [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/NavierStokesSnapBridge.lean:339: theorem projected_extreme_has_gradeTwo_memory [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/PositroidCell.lean:46: theorem h_dim_mono [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/PrimeFibonacciLattice.lean:49: theorem ratio_converges_to_phi [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/PrimeFibonacciLattice.lean:56: theorem most_irrational_barrier [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/PrimeLeeYangHopfieldLimitBridge.lean:51: theorem hopfieldFullCoupling_eq_centeredSpinCoupling [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/PrimeLeeYangHopfieldLimitBridge.lean:56: theorem hopfieldFullCoupling_eq_outerProduct [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/PrimeSUSYVacuum.lean:60: theorem finiteWittenIndexSum_eq_powerset_sum [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/ProjectiveCCR.lean:44: theorem excitedStateSector_eq_orthogonal [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/ProjectiveFoundation.lean:752: theorem baseAction_is_genuine [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/ProjectorNoncommutativityDilationClosure.lean:217: theorem dilation_isGZero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/RelativeModularCenteredFunctional.lean:580: theorem cantorMellinKernel_eq_one_iff_phaseAxis [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/SectorLattice.lean:57: theorem elementarySector_inf_eq_meet [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/SpectralInference.lean:141: theorem spectralProjector_idempotent [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/SplitOctonionAssociator.lean:33: theorem associatorDefect_apply [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/SplitOctonionAssociator.lean:45: theorem associatorDefect_zero_of_associative [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/SplitOctonionAssociator.lean:64: theorem cocycleAssociatorDefect_apply [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/SuperBracketInvolutionParity.lean:247: theorem superBracket_odd_odd_self_eq_square_add_square [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/TimeAsWindingMonodromy3D.lean:71: theorem boundary_eq_det_zero_iff [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/TimeAsWindingMonodromy3D.lean:85: theorem Splus_det_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Canonical/TimeAsWindingMonodromy3D.lean:88: theorem Sminus_det_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/UnifiedSuperchargeAlgebra.lean:3482: theorem hasDrazinIndexOneSurrogate_iff_parabolic [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Canonical/VirasoroCasimirCentralChargeReadback.lean:118: theorem cocycle_on_opposite_modes [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Capstone/ErlangenLanglandsConcrete.lean:89: theorem langlands_lfunction_identity_is_recorded_as_debt [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Capstone/ErlangenLanglandsUnification.lean:97: theorem langlands_lfunction_zeta_is_recorded_as_debt [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Cartan/Involution.lean:104: lemma Pplus_apply [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Cartan/Involution.lean:107: lemma Pminus_apply [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Clifford/AlbertBottConformalBridge.lean:58: theorem cl44_stage [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Clifford/Cl11TensorTower.lean:88: theorem wittCreationBase_eq_half_gamma_plus_phaseAxis [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/Cl11TensorTower.lean:93: theorem wittAnnihilationBase_eq_half_gamma_sub_phaseAxis [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/Cl11TensorTower.lean:209: theorem jwRealEncodedCreation_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Clifford/Cl44Witt.lean:124: theorem witt_CAR_ne [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/Cl44Witt.lean:150: theorem cl11_a_sq_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/Cl44Witt.lean:154: theorem cl11_adag_sq_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/Cl4ComplexMatrixPeriodicity.lean:210: theorem mat4C_complex_finrank [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/CliffordInjectivity.lean:85: theorem incl_Cl_split_injective [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/CliffordInjectivity.lean:129: lemma clifford_map_injective_of_injective [proof_hole]
  - contains `sorry`/`admit`
...
lean/InfoGeometry/Clifford/LogCftMonodromy.lean:61: theorem jordanNilpotent_eq_parabolic_block [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/LogCftMonodromy.lean:66: theorem jordanNilpotent_eq_hypercomplex_N [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/LogCftMonodromy.lean:145: theorem virasoroL0Cell_pow [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Clifford/SORRIES/CliffordInjectivity.lean:159: theorem incl_Cl_split_injective [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SPINOR_REPR_COMPLETE.lean:121: theorem BottInclusion_injective [proof_hole]
  - contains `sorry`/`admit`
...
lean/InfoGeometry/Clifford/SpinorRep.lean:94: theorem cl11ToMatrix_is_iso [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRep.lean:187: theorem toMatrix_incl [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRep_COMPLETE.lean:188: theorem incl_via_blockDiagonal [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRep_FULL.lean:127: lemma incl_via_prodEquiv [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRep_Final.lean:141: theorem incl_Cl_split_injective [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRep_Kronecker.lean:113: theorem det_kronecker [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRep_Kronecker.lean:177: theorem incl_Cl_split_injective [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRep_STRATEGY.lean:94: theorem BottInclusion_injective [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:66: def qform11 [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:149: theorem cl11_to_matrix_surj [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:162: theorem cl11_to_matrix_iso [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:181: theorem cl_tensor_iso [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:211: theorem toMatrix_injective [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SpinorRepresentation_STUB.lean:222: theorem incl_Cl_split_injective [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Clifford/SplitCliffordTowerFunctor.lean:65: theorem cl11_dim [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/SplitCliffordTowerFunctor.lean:66: theorem cl22_dim [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Clifford/SplitCliffordTowerFunctor.lean:67: theorem cl33_dim [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/CondensedMatter/CliffordAtomsZ2n.lean:288: theorem local_charge_is_four_bit [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Core/SymmetricLie.lean:705: lemma oddLocalModel_convex [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Dynamics/SouriauBostConnesTheorem.lean:127: theorem quantum_dimension_tau_eq_phi [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/E8/E8TrialityThermalProtection.lean:219: theorem mersenne_7_to_e8 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Eval/ClosureDebtTest.lean:22: theorem nat_add_comm [proof_hole]
  - contains `sorry`/`admit`
...
lean/InfoGeometry/ExponentialFamily/Analytic/LogSumExp.lean:335: lemma logSumExp_deriv_eq_mean [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/External/Auto/ZetaCoordinateSymmetry.lean:12: theorem involution_involutive [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Geometry/ConstructiveCauchyKernel.lean:75: theorem scalarVerifiedInverse_left_inv [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Geometry/MobiusClassification.lean:37: theorem ell_sigma_readback [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/GrandUnification/Su2Su3ProjectiveBridge.lean:21: lemma sum_fin_3 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Hestenes/SpacetimeAlgebra.lean:127: theorem dirac_operator_iff_residual_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/JordanNormalForm.lean:86: lemma JordanBlock_diag [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/JordanNormalForm.lean:89: lemma JordanBlock_superdiag [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/JordanNormalForm.lean:93: lemma JordanBlock_else [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Krein/PolarizedSector.lean:103: theorem spectralProj_decomposition [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/LLM/SinkhornDefectFlow.lean:707: theorem dissipatedHeatRN_nonneg [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Lie/G2FromSplitOctonions.lean:66: theorem dim_is_14 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Lie/G2FromSplitOctonions.lean:68: theorem decomposition_14_eq_8_plus_6 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Lie/G2FromSplitOctonions.lean:74: theorem weyl_dim [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/MaxEnt/JaynesInfoStatMech.lean:393: lemma modularConj_diag_entry [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Modular/PSL2Z.lean:83: theorem val_mul [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Modular/PSL2Z.lean:181: theorem PSL2Z_mul_mk [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Monster/MonsterMoonshineThermal.lean:72: theorem monster_order_factorization [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/OperatorAlgebra/ComplexBoundedOperators/SchurDecomposition.lean:549: theorem tailMatrix_eq_submatrix [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/ComplexBoundedOperators/SchurDecomposition.lean:554: theorem tailMatrix_apply [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/OperatorAlgebra/ErlangenJaynesGromov.lean:826: theorem dualEpsilon_sq_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/OperatorAlgebra/JaynesFiniteState.lean:74: theorem finiteEmpiricalFunctional_map_smul [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/JaynesFiniteState.lean:106: theorem finiteEmpiricalState_map_one [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/OperatorAlgebra/KreinIsotropicCone.lean:257: theorem null_nil_supported [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/OperatorAlgebra/SplitOctonionDerivationWitness.lean:46: theorem rot01_kills_diagonal_unit [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionDerivationWitness.lean:50: theorem rot01_nonzero_on_up0 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:98: theorem ePlus_idempotent [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:99: theorem eMinus_idempotent [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:100: theorem ePlus_mul_eMinus [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:101: theorem eMinus_mul_ePlus [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:130: theorem up0_mul_up1 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:131: theorem up1_mul_up2 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:132: theorem up2_mul_up0 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:133: theorem up1_mul_up0 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:134: theorem up2_mul_up1 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:135: theorem up0_mul_up2 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:137: theorem down0_mul_down1 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:138: theorem down1_mul_down2 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:139: theorem down2_mul_down0 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:140: theorem down1_mul_down0 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:141: theorem down2_mul_down1 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:142: theorem down0_mul_down2 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:145: theorem associator_up0_up1_down1 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:148: theorem associator_up0_up1_down1_ne_zero [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:166: theorem detZ_ePlus [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:167: theorem detZ_eMinus [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:195: theorem conjZ_ePlus [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:196: theorem conjZ_eMinus [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionMultiplication.lean:197: theorem conjZ_zeroZ [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionSymplecticFoundation.lean:50: theorem ePlus_add_eMinus_eq_oneZ [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionSymplecticFoundation.lean:53: theorem H_sq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionSymplecticFoundation.lean:56: theorem detZ_H [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionSymplecticFoundation.lean:59: theorem detZ_oneZ [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SplitOctonionSymplecticFoundation.lean:117: theorem J_sq_neg_oneZ [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/OperatorAlgebra/SuperVirasoroExtension.lean:185: theorem virasoroProject_central_commutes [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SuperVirasoroExtension.lean:199: theorem virasoroProject_lgen_bracket [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SusceptibilityHessian.lean:1480: theorem event_coeff0_eq_fresnel_s [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/SusceptibilityHessian.lean:1492: theorem event_coeff1_eq_fresnel_p [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/OperatorAlgebra/VirasoroProjectPin.lean:118: theorem virasoroProject_lgen_readback [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/OperatorAlgebra/VirasoroProjectPin.lean:124: theorem virasoroProject_cgen_readback [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Optics/JonesCalibration.lean:290: theorem secondCoeff_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Physics/FineStructureDerivation.lean:47: theorem alpha_value [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Physics/FineStructureModels.lean:34: theorem alpha_p_def [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Physics/MDPASJMSouriauDigest.lean:548: theorem compatibleLift_ofStage [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Physics/MDPASJMSouriauDigest.lean:590: theorem bond_entropy_production [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Physics/MDPASJMSouriauGlobalObstruction.lean:47: theorem sphereArea_closed [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Physics/OrbitClassification55.lean:94: theorem determinant_invariant [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Physics/TKKZorn.lean:82: theorem TKKFisherInformationMetric_eq_detZ_polar [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Quantum/ModularAnomaly.lean:62: lemma sigma_zero_clm [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Quantum/PoincareSupercharge.lean:29: theorem casimir_sq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Quantum/RealKCategory.lean:228: lemma roundTrip_smul_eq_smulRoundTrip [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Spectral/Cohomology/Basic.lean:32: def cohomology [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:41: def gysinSequence [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:48: def gysinSequenceZero [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:52: def gysinSequenceOne [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/Gysin.lean:56: def gysinSequenceTwo [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:14: def K_Z_2_cohomology [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:17: def K_Z_2_cohomology_with_coeffs [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:25: def K_Z_2_cohomology_ring [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:28: def K_Z_2_cup_product [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/ProjectiveSpace.lean:31: def real_projective_space_cohomology [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/Serre.lean:25: def serre_spectral_sequence [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/Serre.lean:33: def gysin_sequence [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/Cohomology/Serre.lean:37: def projective_space_cohomology [proof_hole]
  - contains `sorry`/`admit`
...
lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:92: def GType_equiv [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:175: def DecatAdjointDisc [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:178: def DecatAdjointDiscNatural [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:184: def DecatDisc [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:187: def DeloopAdjointLoop [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:190: def DeloopAdjointLoopNatural [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:196: def LoopDeloop [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:199: def StabilizeAdjointForget [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:202: def StabilizeAdjointForgetNatural [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:208: def StabilizeForget [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:211: def StabilizeForget' [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:213: def Stabilization [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:217: def IsTruncGTypeHom [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:219: def IsSetGTypeHom [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:221: def IsTruncGType [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:225: def CGType [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:229: def CGTypeEquivalenceCType [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:231: def CGTypeEquivalenceGrp [proof_hole]
  - contains `sorry`/`admit`

lean/InfoGeometry/Spectral/HigherGroups/Basic.lean:233: def CGTypeEquivalenceAbGrp [proof_hole]
  - contains `sorry`/`admit`
...
lean/InfoGeometry/Spectral/Spectrum/Basic.lean:64: theorem SplitCliffordPrespectrum_step [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Spectral/Spectrum/Basic.lean:74: theorem bottClockStage_sub_self [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Spectral/Spectrum/Basic.lean:78: theorem bottClockStage_pos [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/SuperMetriplectic/Cl44WeylD4.lean:129: theorem cartan_rank_four [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Thermal/FiniteMatrix.lean:181: lemma internalEnergy_eq_gibbsExpectation [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Thermal/FiniteMatrix.lean:206: lemma thermalState_modularShift_invariant [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Thermo/AmariSouriauBridge.lean:72: theorem logPotential_bregman_eq_legendre_bregman [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Thermo/FiniteDiagonal.lean:136: lemma modularShift_diag_fixed [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Thermo/FiniteDiagonal.lean:190: lemma gibbsDensity_diag_pos [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Thermo/SusceptibilityHessian.lean:173: theorem toSusceptibilityDatum_susceptibility [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Thermo/SusceptibilityHessian.lean:266: theorem toDielectricResponseDatum_epsilon [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Thermodynamics/PrimonGasPhaseTransition.lean:84: theorem default_gue_crystal_readout [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Tooling/PipelineSpec.lean:82: theorem spec_bridge_holds [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Topology/AmplituhedronBoundary.lean:64: theorem superAmplitudeVolume_eq [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Topology/AmplituhedronBoundary.lean:339: theorem chiralBoundaryState16_card [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Topology/CuntzMap.lean:46: theorem CuntzMap_unital [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Topology/DiscreteDiracHodgeChiral.lean:152: theorem eckmann_degree_one_laplacian_readout [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Topology/PointedGroups.lean:74: theorem conjugatingBraidAction_one [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Topology/PointedGroups.lean:79: theorem conjugatingBraidAction_mul [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Topology/PointedGroups.lean:110: theorem actionX_readout [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
...
lean/InfoGeometry/Topology/SpinorOrbitStratum.lean:149: theorem q55NegAll_preserves_q55 [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only
