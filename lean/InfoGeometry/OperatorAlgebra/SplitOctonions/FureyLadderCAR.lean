...
@[simp] theorem up_sq (i : Fin 3) :
    up i * up i = zeroZ := by
  fin_cases i
  · exact up0_sq
  · simp [up, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
...
@[simp] theorem down_sq (i : Fin 3) :
    down i * down i = zeroZ := by
  fin_cases i
  · exact down0_sq
  · simp [down, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
  · simp [down, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
...
theorem up_one_mul_down_one :
    up 1 * down 1 = ePlus := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, ePlus, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
  · simp [up, down, ePlus, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
...
theorem up_two_mul_down_two :
    up 2 * down 2 = ePlus := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, ePlus, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
...
theorem down_two_mul_up_two :
    down 2 * up 2 = eMinus := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, eMinus, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
  · simp [up, down, eMinus, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
...
theorem down_one_mul_up_one :
    down 1 * up 1 = eMinus := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, eMinus, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
...
theorem up_one_mul_down_two :
    up 1 * down 2 = zeroZ := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
  · simp [up, down, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
...
theorem down_one_mul_up_two :
    down 1 * up 2 = zeroZ := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
...
theorem up_two_mul_down_one :
    up 2 * down 1 = zeroZ := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
...
theorem down_two_mul_up_one :
    down 2 * up 1 = zeroZ := by
  apply InfoGeometry.Canonical.ZornMatrix.ext
  · simp [up, down, zeroZ, InfoGeometry.Canonical.ZornMatrix.mul,
      InfoGeometry.Canonical.ZornMatrix.dot,
      InfoGeometry.Canonical.ZornMatrix.cross]
...
theorem up_one_mul_down_one_add_down_one_mul_up_one :
    up 1 * down 1 + down 1 * up 1 = ePlus + eMinus := by
  rw [up_one_mul_down_one, down_one_mul_up_one]

theorem up_two_mul_down_two_add_down_two_mul_up_two :
    up 2 * down 2 + down 2 * up 2 = ePlus + eMinus := by
  rw [up_two_mul_down_two, down_two_mul_up_two]

theorem up_one_mul_down_one_sub_down_one_mul_up_one :
    up 1 * down 1 - down 1 * up 1 = ePlus - eMinus := by
  rw [up_one_mul_down_one, down_one_mul_up_one]

theorem up_two_mul_down_two_sub_down_two_mul_up_two :
    up 2 * down 2 - down 2 * up 2 = ePlus - eMinus := by
  rw [up_two_mul_down_two, down_two_mul_up_two]
