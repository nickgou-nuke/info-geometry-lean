...
in a property.  We use the standard cyclic binary Golay code of length 23
generated by
...
/- The QR bound is consumed through its structural counting property: the
...
/-- Specific property message producing a codeword of weight eight (first basis generator). -/
def weightEightMessage : Message := basisMessage 0

/-- A codeword of Hamming weight eight exists (property checked in O(1)). -/
