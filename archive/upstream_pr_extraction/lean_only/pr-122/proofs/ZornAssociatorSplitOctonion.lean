...
/-!
# Zorn Associator and Split-Octonion Calculation
...
We prove a concrete associator calculation using basis vectors:
...
/--
Concrete non-associativity calculation.  The upper vector component is `e₂`.
-/
...
/--
Consolidated split-octonion result: square-zero paravector lanes coexist with
