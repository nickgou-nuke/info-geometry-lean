...
theorem clog_base2_seed_4 : Nat.clog 2 4 = 2 := by decide

/-- M=2, D=5: ⌈log_2 5⌉ = 3 since 2^2 = 4 < 5 but 2^3 = 8 ≥ 5. -/
theorem clog_base2_seed_5 : Nat.clog 2 5 = 3 := by decide

/-- M=3, D=9: ⌈log_3 9⌉ = 2 since 3^2 = 9 ≥ 9. -/
theorem clog_base3_seed_9 : Nat.clog 3 9 = 2 := by decide

/-- M=3, D=10: ⌈log_3 10⌉ = 3 since 3^2 = 9 < 10 but 3^3 = 27 ≥ 10. -/
theorem clog_base3_seed_10 : Nat.clog 3 10 = 3 := by decide

/-- M=10, D=100: ⌈log_10 100⌉ = 2 since 10^2 = 100 ≥ 100. -/
theorem clog_base10_seed_100 : Nat.clog 10 100 = 2 := by decide

/-- M=2, D=1: ⌈log_2 1⌉ = 0 (trivial fiber, no aux bits needed). -/
theorem clog_base2_seed_1 : Nat.clog 2 1 = 0 := by decide
...
theorem fold6_mary_base2_seed : Nat.clog 2 4 = 2 := by decide

/-- M=3 case at m=6: D_f = 4, ⌈log_3 4⌉ = 2 since 3^1=3<4, 3^2=9≥4. -/
theorem fold6_mary_base3_seed : Nat.clog 3 4 = 2 := by decide
