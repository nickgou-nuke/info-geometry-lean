...
-/
def TrivialK0Model : Type := ZMod 1

instance : AddCommGroup TrivialK0Model := by
  simpa [TrivialK0Model] using (inferInstance : AddCommGroup (ZMod 1))
...
theorem anomalousIndex_from_trivial_K0_pairing_zero
  ...
  rw [hPair]
  exact connesChernPairing_zero_of_O2K0Trivial (K0 := K0) (K1 := K1) hK0 k x
