...
- use `python3 tools/run_locked_lake_build.py ...` so a second build fails fast instead of stuttering the workspace
...
- `scripts/docs/auto_tag.py`
- `scripts/docs/generate_library_index.py`
- `scripts/docs/agent_doc_gen.py`
...
- `tools/refresh_blueprint_tags.py` for blueprint tag refresh
