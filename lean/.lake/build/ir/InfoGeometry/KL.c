...
// Imports: public import Init public import InfoGeometry.Basic public import Mathlib
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_info_x2dgeometry_InfoGeometry_KL(uint8_t builtin) {
lean_object * res;
