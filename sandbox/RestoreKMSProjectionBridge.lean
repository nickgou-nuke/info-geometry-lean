...
/-!
# RestoreKMSProjectionBridge

Small sandbox packet for the Bost-Connes projection-level KMS readout.
-/

namespace InfoGeometry.Restore.KMSProjectionBridge
...
theorem S_prime_power (C : InfoGeometry.Canonical.BostConnesKMS.BostConnesCuntzSystem Op)
...
theorem S_prime_power_list_prod
...
end InfoGeometry.Restore.KMSProjectionBridge
