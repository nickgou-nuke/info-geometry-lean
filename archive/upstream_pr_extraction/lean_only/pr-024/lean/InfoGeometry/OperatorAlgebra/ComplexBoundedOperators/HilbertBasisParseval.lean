...
theorem exists_hilbertBasis_complex :
    ∃ (w : Set E) (b : HilbertBasis w ℂ E), ⇑b = ((↑) : w → E) :=
  exists_hilbertBasis ℂ E

theorem hilbertBasis_orthonormal (b : HilbertBasis ι ℂ E) :
    Orthonormal ℂ b :=
  b.orthonormal

/-- Parseval/Fourier reconstruction as a `HasSum`. -/
