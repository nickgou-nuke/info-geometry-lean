...
/-!
# Finite quantum/Fibonacci proof chain readouts

This file keeps the original chapter names, but each declaration now states a
kernel-checked theorem from the finite Fibonacci/Yang-Baxter owner or from
mathlib braided-category coherence.
-/

namespace FormalTheoryQuantum
