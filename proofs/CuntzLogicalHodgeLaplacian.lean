...
theorem logicalDiagonalPart_L00 :
  ...
  have h : (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) * cuntzLogicalMatrixUnit S 0 0 * (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) = cuntzLogicalMatrixUnit S 0 0 := by
    calc
      _ = (cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 0 -
          cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 0) *
          (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) := by rw [sub_mul]
      _ = cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 0 -
          cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 1 -
          (cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 0 -
            cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 1) := by noncomm_ring
      _ = cuntzLogicalMatrixUnit S 0 0 := by simp [h1, h2, h3, h4]
  rw [h]
...
theorem logicalDiagonalPart_L11 :
  ...
  have h : (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) * cuntzLogicalMatrixUnit S 1 1 * (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) = cuntzLogicalMatrixUnit S 1 1 := by
    calc
      _ = (cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 1 -
          cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 1) *
          (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) := by rw [sub_mul]
      _ = cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 0 -
          cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 1 -
          (cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 0 -
            cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 1) := by noncomm_ring
      _ = cuntzLogicalMatrixUnit S 1 1 := by simp [h1, h2, h3, h4]
  rw [h]
...
theorem logicalDiagonalPart_L01 :
  ...
  have h : (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) * cuntzLogicalMatrixUnit S 0 1 * (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) = - cuntzLogicalMatrixUnit S 0 1 := by
    calc
      _ = (cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 1 -
          cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 1) *
          (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) := by rw [sub_mul]
      _ = cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 1 * cuntzLogicalMatrixUnit S 0 0 -
          cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 0 1 * cuntzLogicalMatrixUnit S 1 1 -
          (cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 1 * cuntzLogicalMatrixUnit S 0 0 -
            cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 0 1 * cuntzLogicalMatrixUnit S 1 1) := by noncomm_ring
      _ = - cuntzLogicalMatrixUnit S 0 1 := by simp [h1, h2, h3, h4]
  rw [h]
...
theorem logicalDiagonalPart_L10 :
  ...
  have h : (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) * cuntzLogicalMatrixUnit S 1 0 * (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) = - cuntzLogicalMatrixUnit S 1 0 := by
    calc
      _ = (cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 0 -
          cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 0) *
          (cuntzLogicalMatrixUnit S 0 0 - cuntzLogicalMatrixUnit S 1 1) := by rw [sub_mul]
      _ = cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 0 * cuntzLogicalMatrixUnit S 0 0 -
          cuntzLogicalMatrixUnit S 0 0 * cuntzLogicalMatrixUnit S 1 0 * cuntzLogicalMatrixUnit S 1 1 -
          (cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 0 * cuntzLogicalMatrixUnit S 0 0 -
            cuntzLogicalMatrixUnit S 1 1 * cuntzLogicalMatrixUnit S 1 0 * cuntzLogicalMatrixUnit S 1 1) := by noncomm_ring
      _ = - cuntzLogicalMatrixUnit S 1 0 := by simp [h1, h2, h3, h4]
  rw [h]
