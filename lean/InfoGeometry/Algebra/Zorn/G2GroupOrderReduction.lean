...
theorem sylowTwoSubgroup_card_nat :
  ...
  have h_eq : (G2TwoSylowSubgroup.sylowTwoSubgroup : Subgroup SplitOctF2Aut) =
      InfoGeometry.Algebra.Zorn.G2TwoPCSubgroupClosure.unipotentSubgroup :=
    InfoGeometry.Algebra.Zorn.G2TwoPCSubgroupClosure.sylowTwoSubgroup_eq_unipotentSubgroup
  rw [h_eq]
...
theorem nat_card_eq_of_quotient_189
  ...
  rw [Subgroup.card_eq_card_quotient_mul_card_subgroup (s := G2TwoSylowSubgroup.sylowTwoSubgroup),
