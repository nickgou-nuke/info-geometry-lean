...
theorem adjointQuad_eq_QPeirce_smul_e1
  ...
  apply H3Zorn.ext_h3
  · simp [H3Zorn.adjointQuad, QPeirce, e1]
  · simp [H3Zorn.adjointQuad, H3Zorn.smul_readback, e1, h1, hc]
  · simp [H3Zorn.adjointQuad, H3Zorn.smul_readback, e1, h1, ha]
  · ext i
    simp [H3Zorn.adjointQuad, H3Zorn.smul_readback, e1, ha, hc,
      ZornVectorMatrix.zero]
  · ext i
    simp [H3Zorn.adjointQuad, H3Zorn.smul_readback, e1, h1, ha, hc,
      ZornVectorMatrix.zero]
  · ext i
    simp [H3Zorn.adjointQuad, H3Zorn.smul_readback, e1, h1, ha, hc,
      ZornVectorMatrix.zero]
...
theorem crossProduct_e1_of_peirce0
  ...
  apply H3Zorn.ext_h3
  · simp [H3Zorn.crossProduct, H3Zorn.adjointQuad, H3Zorn.add_readback,
      H3Zorn.sub_readback, e1, e1CrossReadout, h1, ha, hc,
