import InfoGeometry.Topology.KleinGlideCoveringAtlas
...
open KleinGlideCoveringAtlas InfoGeometry.Canonical.KleinSixStateBundle
...
theorem deckFiberMap_add (omega : ℂ)
  ...
  · change v = theta.mulVec (theta.mulVec v)
    rw [Matrix.mulVec_mulVec, ← pow_two, theta_sq]
