...
/-!
# Central sign evidence for the native `Spin(5,5)` action
...
action is trivial and it is nontrivial as a group element.  This owner records
only that kernel witness; it does not classify the full native kernel.
-/
