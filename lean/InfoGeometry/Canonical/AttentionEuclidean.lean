...
noncomputable abbrev euclideanAttentionParams
    (q : S)
    (ctx : InfoGeometry.Canonical.Attention.ContextWindow n S V) :
    InfoGeometry.GrandCanonical.GrandCanonicalParams (Fin n) :=
  InfoGeometry.Canonical.Attention.attentionParams q ctx euclideanMatchForm
...
noncomputable abbrev euclideanAttentionWeights
    ...
    (ctx : InfoGeometry.Canonical.Attention.ContextWindow n S V)
    (β : ℝ) (i : Fin n) : ℝ :=
  InfoGeometry.Canonical.Attention.attentionWeights q ctx euclideanMatchForm β i
...
noncomputable abbrev euclideanAttentionHead
    ...
    (ctx : InfoGeometry.Canonical.Attention.ContextWindow n S V)
    (β : ℝ) : V :=
  InfoGeometry.Canonical.Attention.attentionHead q ctx euclideanMatchForm β
...
lemma euclideanAttentionWeights_sum_one
  ...
  simpa [euclideanAttentionWeights] using
    InfoGeometry.Canonical.Attention.attentionWeights_sum_one q ctx euclideanMatchForm β
...
lemma euclideanAttentionWeights_nonneg
  ...
  haveI : Nonempty (Fin n) := ⟨⟨0, Fact.out⟩⟩
  simpa [euclideanAttentionWeights] using
    InfoGeometry.Canonical.Attention.attentionWeights_nonneg q ctx euclideanMatchForm β i
...
lemma euclideanAttentionWeights_le_one
  ...
  haveI : Nonempty (Fin n) := ⟨⟨0, Fact.out⟩⟩
  simpa [euclideanAttentionWeights] using
    InfoGeometry.Canonical.Attention.attentionWeights_le_one q ctx euclideanMatchForm β i
