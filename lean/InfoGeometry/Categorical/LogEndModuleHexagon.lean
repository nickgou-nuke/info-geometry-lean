...
theorem hexagon_identity₁
  ...
  intro x y z
  simp [tensorObj, associatorHom, braidingHom, tensorHom, LinearMap.comp_apply,
    TensorProduct.map_tmul, TensorProduct.assoc_tmul, TensorProduct.comm_tmul]
...
theorem hexagon_identity₂
  ...
  apply TensorProduct.ext_threefold'
  intro x y z
  simp [tensorObj, associatorInv, braidingHom, tensorHom, LinearMap.comp_apply,
    TensorProduct.map_tmul, TensorProduct.assoc_symm_tmul, TensorProduct.comm_tmul]
