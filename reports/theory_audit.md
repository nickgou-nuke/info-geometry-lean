...
Generated: 2026-07-24 03:47:17Z
...
lean/InfoGeometry/Arithmetic/GenuineBounds.lean:23:Only theorems with actual proofs are included. No `sorry` placeholders.
lean/InfoGeometry/Arithmetic/GenuineBounds.lean:403:  -- This is marked with `sorry` because the full proof requires 20+ pages of analytic
lean/InfoGeometry/Arithmetic/GenuineBounds.lean:407:  have h₆ : |(Nat.primeCounting x : ℝ) - (∫ (t : ℝ) in (2 : ℝ)..(x : ℝ), 1 / Real.log t)| < (x : ℝ) / (8 * Real.pi * Real.sqrt (x : ℝ) * Real.log (x : ℝ)) := by sorry
...
lean/InfoGeometry/Automath/Generated/hyp_pin55_krein.lean:11:  sorry
...
- Total placeholder occurrences in canonical tree: 140
...
[audit] Files with namespace InfoGeometry*: 3872
...
```text
wrote /tmp/proof_gap_report.md (25 gaps)
...
```text
wrote /tmp/proof_gap_report.review.md (25 gaps)
...
lean/InfoGeometry/Arithmetic/GenuineBounds.lean:334: theorem quantum_counting_chernoff_bound [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/GenuineBounds.lean:340: theorem rosser_schoenfeld_bound [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/GenuineBounds.lean:344: theorem chebyshev_theta_bound [skeletal_proof]
  - proof body appears to be `rfl`/`trivial`/`simp`/`aesop`-only

lean/InfoGeometry/Arithmetic/GenuineBounds.lean:392: theorem rosser_schoenfeld_prime_count_bound [proof_hole]
...
lean/InfoGeometry/Automath/Generated/hyp_pin55_krein.lean:8: theorem hyp_pin55_krein [proof_hole]
  - contains `sorry`/`admit`
