...
theorem stokesModularActionHomeomorph_trans
    (rho₁ rho₁Inv rho₂ rho₂Inv : M6C)
    (h₁left : rho₁Inv * rho₁ = 1)
    (h₁right : rho₁ * rho₁Inv = 1)
    (h₂left : rho₂Inv * rho₂ = 1)
    (h₂right : rho₂ * rho₂Inv = 1) :
    (stokesModularActionHomeomorph rho₁ rho₁Inv h₁left h₁right).trans
        (stokesModularActionHomeomorph rho₂ rho₂Inv h₂left h₂right) =
      stokesModularActionHomeomorph
  ...
  intro q
  simp only [Homeomorph.trans_apply, stokesModularActionHomeomorph_apply,
