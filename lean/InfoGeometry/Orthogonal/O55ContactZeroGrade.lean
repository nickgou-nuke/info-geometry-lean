...
theorem zero_generator_grade_packet
    ...
    outerZeroGenerator a b ∈ contactGradeSpace 0 ∧
      middleZeroGenerator w z ∈ contactGradeSpace 0 := by
...
theorem middleZero_action_negativeOne
  ...
  rw [splitRankTwo_bracket]
  simp only [pairing_middle_outerMinus, pairing_middle_middle,
    zero_smul, sub_zero, zero_sub]
  rw [splitRankTwo_swap, splitRankTwo_swap]
  module
...
theorem middleZero_action_positiveOne
  ...
  rw [splitRankTwo_bracket]
  simp only [pairing_middle_outerPlus, pairing_middle_middle,
    zero_smul, sub_zero, zero_sub]
  rw [splitRankTwo_swap, splitRankTwo_swap]
  module
