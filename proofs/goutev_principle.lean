...
/-- The minimal Jaynes datum records the KMS inverse-temperature coordinate as
its entropy coordinate in this structural bridge. -/
...
def bridge_geometric_zeta_lightcone : BridgeArtifact where
  ...
  exported_symbols := [
    ...
    "geometric_lightcone_iff_det_zero"
  ]
...
def bridge_trifactor_geometry : BridgeArtifact where
  ...
  exported_symbols := [
    ...
    "TrifactorGeometry.paravector_null_iff"
  ]
