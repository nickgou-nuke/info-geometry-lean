...
Finite ER-incidence, monogamous pairing, and constructive property complexity.
...
supplied circuit property, not as a proof of minimal circuit complexity.
-/
...
/-
This is constructive property complexity: the length of the supplied circuit.

It is an upper-bound property for usual minimal circuit complexity, not a proof
...
The bridge length readout is not an independent property; it is defined to
