...
| 6 | `InfoGeometry.Canonical.BulkBoundaryRegularizationBridge` | 306.399 | package_reprojection | 0/26/3 | 75 | replace surrogates, then collapse package layer |
| 7 | `InfoGeometry.Canonical.TypeIIIContinuousCoreReal` | 304.533 | surrogate_or_vacuous | 0/12/14 | 31 | replace surrogates, then collapse package layer |
...
| 18 | `InfoGeometry.Physics.DIIISymmetryAtom` | 108.131 | package_reprojection | 0/13/0 | 49 | collapse package layer |
| 19 | `InfoGeometry.Canonical.WeylTransportChiralBridge` | 66.790 | package_reprojection | 0/8/0 | 36 | collapse package layer |
| 20 | `InfoGeometry.Quantum.InvolutionCore` | 63.474 | package_reprojection | 0/9/0 | 22 | collapse package layer |
