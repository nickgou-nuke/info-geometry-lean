...
class ProofSeeker:
    ...
    def digest(
        ...
        repair_prompt = (
            ...
            "Refuse wrappers, deferred interfaces, synthetic helper layers, fake bridge modules, boilerplate, "
            ...
            "4. Do not create wrappers, deferred interfaces, structures, classes, witness packets, certificate packets, "
