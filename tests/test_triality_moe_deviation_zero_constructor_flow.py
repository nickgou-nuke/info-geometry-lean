...
def test_deviation_zero_constructor_exposes_zero_residual_flow_route() -> None:
    ...
    assert "observerDefectResidual_eq_zero_of_deviation_eq_zero (CIK := CIK) (obs := obs) hDev" in triality_text
