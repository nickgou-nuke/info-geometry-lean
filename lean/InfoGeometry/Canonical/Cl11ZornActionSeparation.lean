...
theorem induced_conjugations_commute (X : Mat2) :
  ...
  fin_cases i <;> fin_cases j <;>
    simp [Eplus, J1, Matrix.mul_apply, Matrix.vecMul, Matrix.vecHead,
      Matrix.vecTail, Matrix.cons_val_zero, Fin.sum_univ_two]
...
theorem operator_null_not_square_zero :
  ...
  have hbad : Eplus * J1 = J1 * Eplus := by
    simpa [noncommutingVector] using hc.1
  have h01 := congrArg (fun M : Mat2 => M 0 1) hbad
  norm_num [Eplus, J1, Matrix.mul_apply, Fin.sum_univ_two] at h01
