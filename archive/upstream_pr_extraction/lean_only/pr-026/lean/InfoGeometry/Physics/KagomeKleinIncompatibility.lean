...
-/
def KleinBottleSymmetry (θ : ℝ) : Prop :=
  Real.sin θ = 0
...
-/
def KagomeSymmetry (θ : ℝ) : Prop :=
  θ = Real.pi / 3 ∨ θ = 2 * Real.pi / 3
