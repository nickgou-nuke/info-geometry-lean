...
| `InfoGeometry.Canonical.GrandSynthesis` | `mixed_capstone_surface` | mixes real theorem content with high-level capstone packaging | Contains exact determinant/Jacobian lemmas and real bridge theorems, but also capstone packaging/orchestration layers. |
