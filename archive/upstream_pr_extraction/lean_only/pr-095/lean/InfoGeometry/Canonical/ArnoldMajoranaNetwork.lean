...
/--
If a transported Weyl-plus zero-mode property already exists for the conjugated
chain operator, and every expert fixes any such property pointwise, then the
Arnold-Majorana network has a concrete fixed nonzero transported Weyl-plus zero
mode on the constant-token input generated by that property.
-/
...
/--
If a transported Weyl-minus zero-mode property already exists for the conjugated
chain operator, and every expert fixes any such property pointwise, then the
...
transported Weyl-plus zero-mode property.
-/
...
Bogoliubov transform preserves chirality polarization and the experts fix every
transported Weyl-minus zero-mode property.
-/
