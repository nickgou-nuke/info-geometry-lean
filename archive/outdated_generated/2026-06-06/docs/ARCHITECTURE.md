...
| T34 | clockAxis as intertwiner | Heisenberg↔Schrödinger | ✅ | `ConformalSL2GeneratorBridge` |
| T35 | Weyl V₄ → Klein cocycle | Topology | ✅ | `SelfDualWeylRootKleinBridge` |
| T36 | V₄ ⋊ S₃ semidirect | Triality | ✅ | `V4SemidirectS3Bridge` |
| T37 | Cl(5,5) spinor± fragmentation | Boundary | ✅ | `Cl55V4SpinorFragmentation` |
| T38 | Klein bottle boundary states | Topology | ✅ | `KleinBoundaryStates` |
| T39 | Drazin–Penrose anomaly | Operator theory | ✅ | `DrazinPenroseAnomalyOwner` |
| T40 | Fibonacci tower scaling | Lattice | ✅ | `PrimeFibonacciLattice` |
| T41 | Primon gas / Fib(n) boundary | Arithmetic | ✅ | `PrimonFibBoundaryBridge` |
