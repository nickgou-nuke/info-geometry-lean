...
Generated: `2026-05-14T19:39:38.574997+00:00`
Root: `lean/InfoGeometry/Canonical/OperatorialCramerRaoStateFirstChunk3.lean`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `lean/InfoGeometry/Canonical/OperatorialCramerRaoStateFirstChunk3.lean` | `advisory` | 5 | 0 | 1 | 3 | 4 |

## Findings by file

### `lean/InfoGeometry/Canonical/OperatorialCramerRaoStateFirstChunk3.lean`
- module: `InfoGeometry.Canonical.OperatorialCramerRaoStateFirstChunk3`
- status: `advisory`
- debt_score: `5`
- findings:
  ...
  - L51 [soft] `skeletal-proof` in `theorem fierzAdmissibleState_true` — proof appears to close via minimal tactic one-liner
