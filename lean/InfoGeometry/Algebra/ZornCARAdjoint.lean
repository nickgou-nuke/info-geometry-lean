  ...
  · intro h
    have hsum : X.a ^ 2 + X.b ^ 2 + X.v 0 ^ 2 + X.v 1 ^ 2 + X.v 2 ^ 2 +
      ...
      simpa [coefficientPairing, ZornVec3.dot, Fin.sum_univ_three, pow_two,
        add_assoc] using h
    have ha : X.a = 0 := by nlinarith [sq_nonneg (X.a), sq_nonneg (X.b),
      sq_nonneg (X.v 0), sq_nonneg (X.v 1), sq_nonneg (X.v 2),
      sq_nonneg (X.w 0), sq_nonneg (X.w 1), sq_nonneg (X.w 2)]
    have hb : X.b = 0 := by nlinarith [sq_nonneg (X.a), sq_nonneg (X.b),
      sq_nonneg (X.v 0), sq_nonneg (X.v 1), sq_nonneg (X.v 2),
      sq_nonneg (X.w 0), sq_nonneg (X.w 1), sq_nonneg (X.w 2)]
    have hv : ∀ i, X.v i = 0 := by
      intro i
      fin_cases i <;> nlinarith [sq_nonneg (X.a), sq_nonneg (X.b),
        sq_nonneg (X.v 0), sq_nonneg (X.v 1), sq_nonneg (X.v 2),
        sq_nonneg (X.w 0), sq_nonneg (X.w 1), sq_nonneg (X.w 2)]
