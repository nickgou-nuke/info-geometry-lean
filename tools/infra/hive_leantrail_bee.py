#!/usr/bin/env python3
"""LeanTrail-backed Hive proof bee lane.

Alternative retrieval lane for Hive that keeps the same Lean verification/fossilization
pipeline but uses LeanTrail snapshot retrieval instead of Arango gravity retrieval.
"""
...
DEFAULT_TASK_KIND = "proof.search.leantrail"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--worker-id", default="hive-leantrail-bee-001")
...
def config_from_args(args: argparse.Namespace) -> hive_bee.BeeConfig:
    ...
    return hive_bee.BeeConfig(
        ...
        retrieval_strategy="leantrail",
        task_kind=str(args.task_kind),
        leansearch_base_url=hive_bee.DEFAULT_LEANSEARCH_BASE_URL,
