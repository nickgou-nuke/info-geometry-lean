...
theorem aba_eq_a
    (h : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B) : A * B * A = A :=
  InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse.aba_eq_a h

theorem bab_eq_b
    (h : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B) : B * A * B = B :=
  InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse.bab_eq_b h

theorem ab_adj_eq
    (h : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B) : (A * B)† = A * B :=
  InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse.ab_adj_eq h

theorem ba_adj_eq
    (h : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B) : (B * A)† = B * A :=
...
theorem MoorePenrose_unique {A B C : R}
    (hB : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B)
    (hC : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A C) : B = C :=
  InfoGeometry.Singular.MoorePenrose.MoorePenrose_unique hB hC

def MP_Projector (A B : R)
    (_h : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B) : R :=
  InfoGeometry.Singular.MoorePenrose.MP_Projector A B _h

lemma MP_Projector_idempotent {A B : R}
    (h : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B) :
    (MP_Projector A B h) * (MP_Projector A B h) = MP_Projector A B h :=
  InfoGeometry.Singular.MoorePenrose.MP_Projector_idempotent h

lemma MP_Projector_self_adjoint {A B : R}
    (h : InfoGeometry.Singular.MoorePenrose.IsMoorePenroseInverse A B) :
