...
/-- On the critical line, the rotational field is tangent and the dilation
coordinate field is normal, with the explicit quadratic magnitude. -/
...
/-- The corrected finite capstone packet: the reflection midpoint, the two
Riccati zeros, and the orthogonality identity hold simultaneously. -/
