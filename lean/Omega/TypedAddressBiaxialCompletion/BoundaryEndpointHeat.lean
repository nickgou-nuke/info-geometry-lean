...
theorem paper_typed_address_biaxial_completion_boundary_endpoint_heat
    ...
    monotoneToEndpointAtom ∧ exponentialErrorBound ∧ minDepthFormula := by
  exact
    ⟨hMonotoneToEndpointAtom, hExponentialErrorBound,
      deriveMinDepthFormula hMonotoneToEndpointAtom hExponentialErrorBound⟩
