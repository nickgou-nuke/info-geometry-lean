...
theorem canonical_five_grade_weight_packet :
  ...
  constructor
  · norm_num [Alg.br, Alg.basisH, Alg.basisU]
  · norm_num [Alg.br, Alg.basisH, Alg.basisV]
...
theorem g2_cyclotomic_sector_packet (r : Root) :
    sector (cyclotomicS1Perm r) = sector r ∧
      sector (cyclotomicS2Perm r) = sector r ∧
      sector (cyclotomicCoxeterPerm r) = sector r :=
  ⟨simple_reflection_one_preserves_sector r,
    simple_reflection_two_preserves_sector r,
    coxeter_preserves_sector r⟩
