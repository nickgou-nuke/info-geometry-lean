...
theorem chiralNumber_sum :
  ...
  noncomm_ring [gammaChiral_sq, gammaChiral_rawFockNumber_comm] <;> module
...
theorem creation_flips_plus_to_minus (i : Fin 5) :
  ...
  have he := gammaChiral_e_anticomm i
  have hmove : PMinus * creation i = creation i * PPlus := by
    unfold PMinus PPlus
    change gammaChiral * creation i = -(creation i * gammaChiral) at he
    noncomm_ring [he]
  rw [hmove, mul_assoc, PPlus_sq]
...
theorem creation_flips_minus_to_plus (i : Fin 5) :
  ...
  have he := gammaChiral_e_anticomm i
  have hmove : PPlus * creation i = creation i * PMinus := by
    unfold PMinus PPlus
    change gammaChiral * creation i = -(creation i * gammaChiral) at he
    noncomm_ring [he]
  rw [hmove, mul_assoc, PMinus_sq]
...
theorem annihilation_flips_plus_to_minus (i : Fin 5) :
  ...
  have hf := gammaChiral_f_anticomm i
  have hmove : PMinus * annihilation i = annihilation i * PPlus := by
    unfold PMinus PPlus
    change gammaChiral * annihilation i = -(annihilation i * gammaChiral) at hf
    noncomm_ring [hf]
  rw [hmove, mul_assoc, PPlus_sq]
...
theorem annihilation_flips_minus_to_plus (i : Fin 5) :
  ...
  have hf := gammaChiral_f_anticomm i
  have hmove : PPlus * annihilation i = annihilation i * PMinus := by
    unfold PMinus PPlus
    change gammaChiral * annihilation i = -(annihilation i * gammaChiral) at hf
    noncomm_ring [hf]
  rw [hmove, mul_assoc, PMinus_sq]
