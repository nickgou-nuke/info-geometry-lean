...
structure DrazinGreenData
  ...
  P_harm : Obs
  index : ℕ
  drazin_law : IsDrazinInverse L LD index
...
theorem P_reg_idempotent :
  ...
  rw [G.P_reg_def]
  exact IsDrazinInverse.projection_is_idempotent G.drazin_law
...
theorem P_harm_idempotent :
  ...
  simpa [IsDrazinInverse.complementaryProjection, IsDrazinInverse.projection] using
    IsDrazinInverse.complementaryProjection_is_idempotent G.drazin_law
