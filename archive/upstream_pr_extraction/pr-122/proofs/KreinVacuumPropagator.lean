...
theorem krein_vacuum_propagator_package
  ...
  · constructor
    · exact chiral_trace_conjugation C C.propagator
    · exact uv_divergence_cancellation C
...
/-- Closed-form finite Klein context with propagator `G = J`. -/
...
/-- Closed-form finite TOMITA context with propagator `G = J`. -/
...
theorem klein_tomita_vacuum_bridge :
  ...
  by
    constructor
    · exact kleinBottleJ_vacuumBubble_vanishes
    · exact tomitaBottleJ_vacuumBubble_vanishes
