def gen():
    out = []
    out.append("""theorem basisBivector_mul_omega (i : Fin 6) : 
  ...
  fin_cases i""")
    ...
    have H : (ι Q (gamma Q 0) * ι Q (gamma Q 1)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3)) = - (algebraMap R _ (Q (gamma Q 0) * Q (gamma Q 1)) * basisBivector Q 3) := by
      calc (ι Q (gamma Q 0) * ι Q (gamma Q 1)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3))
        ...
        _ = - (Q (gamma Q 0) • Q (gamma Q 1) • (ι Q (gamma Q 2) * ι Q (gamma Q 3))) := by simp only [← Algebra.smul_def, smul_mul_assoc, mul_smul_comm, smul_smul, mul_assoc]
        _ = - ((Q (gamma Q 0) * Q (gamma Q 1)) • (ι Q (gamma Q 2) * ι Q (gamma Q 3))) := by simp only [smul_smul, mul_comm (Q (gamma Q 1)) (Q (gamma Q 0))]
        _ = - (algebraMap R _ (Q (gamma Q 0) * Q (gamma Q 1)) * (ι Q (gamma Q 2) * ι Q (gamma Q 3))) := by simp only [Algebra.smul_def]
    ...
    have H : (ι Q (gamma Q 0) * ι Q (gamma Q 2)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3)) = - (algebraMap R _ (Q (gamma Q 0) * Q (gamma Q 2)) * basisBivector Q 4) := by
      calc (ι Q (gamma Q 0) * ι Q (gamma Q 2)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3))
        ...
        _ = Q (gamma Q 0) • ι Q (gamma Q 1) * Q (gamma Q 2) • ι Q (gamma Q 3) := by simp only [← Algebra.smul_def]
        _ = (Q (gamma Q 0) * Q (gamma Q 2)) • (ι Q (gamma Q 1) * ι Q (gamma Q 3)) := by simp only [smul_mul_assoc, mul_smul_comm, smul_smul, mul_comm (Q (gamma Q 2)) (Q (gamma Q 0))]
        _ = (Q (gamma Q 0) * Q (gamma Q 2)) • - (ι Q (gamma Q 3) * ι Q (gamma Q 1)) := by rw [h13]
        _ = - ((Q (gamma Q 0) * Q (gamma Q 2)) • (ι Q (gamma Q 3) * ι Q (gamma Q 1))) := by rw [smul_neg]
        _ = - (algebraMap R _ (Q (gamma Q 0) * Q (gamma Q 2)) * (ι Q (gamma Q 3) * ι Q (gamma Q 1))) := by rw [Algebra.smul_def]
    ...
    have H : (ι Q (gamma Q 0) * ι Q (gamma Q 3)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3)) = - (algebraMap R _ (Q (gamma Q 0) * Q (gamma Q 3)) * basisBivector Q 5) := by
      calc (ι Q (gamma Q 0) * ι Q (gamma Q 3)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3))
        ...
        _ = - (Q (gamma Q 0) • ι Q (gamma Q 1) * ι Q (gamma Q 2) * Q (gamma Q 3) • 1) := by simp only [← Algebra.smul_def]
        _ = - ((Q (gamma Q 0) * Q (gamma Q 3)) • (ι Q (gamma Q 1) * ι Q (gamma Q 2))) := by simp only [smul_mul_assoc, mul_smul_comm, smul_smul, mul_assoc, mul_one, mul_comm (Q (gamma Q 3)) (Q (gamma Q 0))]
        _ = - (algebraMap R _ (Q (gamma Q 0) * Q (gamma Q 3)) * (ι Q (gamma Q 1) * ι Q (gamma Q 2))) := by rw [Algebra.smul_def]
    ...
    have H : (ι Q (gamma Q 2) * ι Q (gamma Q 3)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3)) = - (algebraMap R _ (Q (gamma Q 2) * Q (gamma Q 3)) * basisBivector Q 0) := by
      calc (ι Q (gamma Q 2) * ι Q (gamma Q 3)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3))
        ...
        _ = - (ι Q (gamma Q 0) * ι Q (gamma Q 1) * Q (gamma Q 2) • 1 * Q (gamma Q 3) • 1) := by simp only [← Algebra.smul_def]
        _ = - ((Q (gamma Q 2) * Q (gamma Q 3)) • (ι Q (gamma Q 0) * ι Q (gamma Q 1))) := by simp only [smul_mul_assoc, mul_smul_comm, smul_smul, mul_assoc, mul_one, mul_comm (Q (gamma Q 3)) (Q (gamma Q 2))]
        _ = - (algebraMap R _ (Q (gamma Q 2) * Q (gamma Q 3)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1))) := by rw [Algebra.smul_def]
    ...
    have H : (ι Q (gamma Q 3) * ι Q (gamma Q 1)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3)) = - (algebraMap R _ (Q (gamma Q 3) * Q (gamma Q 1)) * basisBivector Q 1) := by
      calc (ι Q (gamma Q 3) * ι Q (gamma Q 1)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3))
        ...
        _ = ι Q (gamma Q 0) * ι Q (gamma Q 3) * Q (gamma Q 1) • 1 * ι Q (gamma Q 2) * ι Q (gamma Q 3) := by simp only [← Algebra.smul_def]
        _ = Q (gamma Q 1) • (ι Q (gamma Q 0) * ι Q (gamma Q 3) * ι Q (gamma Q 2) * ι Q (gamma Q 3)) := by simp only [smul_mul_assoc, mul_smul_comm, smul_smul, mul_assoc, mul_one]
        _ = Q (gamma Q 1) • (ι Q (gamma Q 0) * (ι Q (gamma Q 3) * ι Q (gamma Q 2)) * ι Q (gamma Q 3)) := by simp only [mul_assoc]
        _ = Q (gamma Q 1) • (ι Q (gamma Q 0) * - (ι Q (gamma Q 2) * ι Q (gamma Q 3)) * ι Q (gamma Q 3)) := by rw [h32]
        _ = - (Q (gamma Q 1) • (ι Q (gamma Q 0) * ι Q (gamma Q 2) * (ι Q (gamma Q 3) * ι Q (gamma Q 3)))) := by simp only [mul_neg, neg_mul, smul_neg, ← mul_assoc]
        _ = - (Q (gamma Q 1) • (ι Q (gamma Q 0) * ι Q (gamma Q 2) * algebraMap R _ (Q (gamma Q 3)))) := by rw [sq3]
        _ = - (Q (gamma Q 1) • (ι Q (gamma Q 0) * ι Q (gamma Q 2) * Q (gamma Q 3) • 1)) := by simp only [← Algebra.smul_def]
        _ = - ((Q (gamma Q 3) * Q (gamma Q 1)) • (ι Q (gamma Q 0) * ι Q (gamma Q 2))) := by simp only [smul_mul_assoc, mul_smul_comm, smul_smul, mul_assoc, mul_one, mul_comm (Q (gamma Q 1)) (Q (gamma Q 3))]
        _ = - (algebraMap R _ (Q (gamma Q 3) * Q (gamma Q 1)) * (ι Q (gamma Q 0) * ι Q (gamma Q 2))) := by rw [Algebra.smul_def]
    ...
    have H : (ι Q (gamma Q 1) * ι Q (gamma Q 2)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3)) = - (algebraMap R _ (Q (gamma Q 1) * Q (gamma Q 2)) * basisBivector Q 2) := by
      calc (ι Q (gamma Q 1) * ι Q (gamma Q 2)) * (ι Q (gamma Q 0) * ι Q (gamma Q 1) * ι Q (gamma Q 2) * ι Q (gamma Q 3))
        ...
        _ = - (ι Q (gamma Q 0) * Q (gamma Q 1) • 1 * Q (gamma Q 2) • 1 * ι Q (gamma Q 3)) := by simp only [← Algebra.smul_def]
        _ = - ((Q (gamma Q 1) * Q (gamma Q 2)) • (ι Q (gamma Q 0) * ι Q (gamma Q 3))) := by simp only [smul_mul_assoc, mul_smul_comm, smul_smul, mul_assoc, mul_one]
        _ = - (algebraMap R _ (Q (gamma Q 1) * Q (gamma Q 2)) * (ι Q (gamma Q 0) * ι Q (gamma Q 3))) := by rw [Algebra.smul_def]
    ...
    open("test_cases_all.lean", "w").write("\n".join(out))
