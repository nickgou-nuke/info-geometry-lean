...
theorem upperRoot_anticommutator_zero (u v : Vec3) :
  ...
  change zornMul (upperVectorZorn u) (upperVectorZorn v) +
      zornMul (upperVectorZorn v) (upperVectorZorn u) = 0
  rw [upperVectorZorn_mul_upperVectorZorn,
    upperVectorZorn_mul_upperVectorZorn, cross3_swap]
  ext <;> simp [lowerVectorZorn, zornMk, Matrix.cons_val_two]
...
theorem lowerRoot_anticommutator_zero (u v : Vec3) :
  ...
  change zornMul (lowerVectorZorn u) (lowerVectorZorn v) +
      zornMul (lowerVectorZorn v) (lowerVectorZorn u) = 0
  rw [lowerVectorZorn_mul_lowerVectorZorn,
    lowerVectorZorn_mul_lowerVectorZorn, cross3_swap]
  ext <;> simp [upperVectorZorn, zornMk, Matrix.cons_val_two]
...
theorem splitCliffordGenerator_sq (u : Vec3) :
  ...
  ext i <;>
    ...
    try { fin_cases i <;> simp [Matrix.cons_val_two] <;> ring } <;>
    ring
...
@[simp] theorem dot3_e1_e1 : dot3 e1 e1 = 1 := by
  norm_num [dot3, e1, Matrix.cons_val_two]
@[simp] theorem dot3_e2_e2 : dot3 e2 e2 = 1 := by
  norm_num [dot3, e2, Matrix.cons_val_two]
@[simp] theorem dot3_e3_e3 : dot3 e3 e3 = 1 := by
  norm_num [dot3, e3, Matrix.cons_val_two]

@[simp] theorem cross3_e1_e2 : cross3 e1 e2 = e3 := by
  funext i
  fin_cases i <;> norm_num [cross3, e1, e2, e3, Matrix.cons_val_two]
