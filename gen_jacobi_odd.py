    ...
    | mem x hxgen =>
        ...
        | mem y hygen =>
            ...
            all_goals
              ...
              | mem z hzgen =>
                  rcases hzgen with ⟨a, rfl⟩
                  cases a <;> ext k <;> fin_cases k <;>
...
content = open("lean/InfoGeometry/Clifford/ConformalSpinorBridge.lean").read()
new_content = content.replace("  jacobi_odd_odd := by\n    sorry", "  jacobi_odd_odd := by\n" + proof)
open("lean/InfoGeometry/Clifford/ConformalSpinorBridge.lean", "w").write(new_content)
