...
/-! Direct finite synthesis of the tube barrier, Hessian determinant,
confinement, scalar convexity, and dissipation readouts. -/
theorem verification_capstone
  ...
  exact grand_dikin_metriplectic_tube_synthesis Y v1 v2 r hr_nonneg hr_lt
    h_in x st
