...
This module is intentionally non-axiomatic: it records explicit
assumptions that connect macroscopic thermodynamic fields to supplied
finite microstate data.
-/
