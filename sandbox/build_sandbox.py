...
content = """import InfoGeometry.Canonical.SouriauTomitaModularFlowBridge
...
with open("/home/goutev/repos/info-geometry-lean/sandbox/SouriauOperatorialLogPotential.lean", "w") as f:
    f.write(content)
