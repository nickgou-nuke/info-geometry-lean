...
- `docs/research/<OUTPUT_STEM>.md` (topic dossier)
- `Research/Context/<OUTPUT_STEM>.lean` (Lean context pack)
- `docs/research/<OUTPUT_STEM>-architecture.md` (architecture snapshot)
