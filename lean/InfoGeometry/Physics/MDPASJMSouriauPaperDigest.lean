...
/-!
# MDPAS-JM Souriau owner imports

The finite spin-particle, thermodynamic, obstruction, and direct-system
theorems are owned by the imported modules.  This paper-digest path remains
for compatibility and does not duplicate packet structures or readout lemmas.
-/
