...
structure TKKMobiusGroupClosure
  ...
  /-- Negative grade integrates to translation-like projective transformations. -/
  ...
  /-- Grade zero integrates to the structure group: `O(4,4)` plus Weyl scale data. -/
  ...
  /-- Positive grade is generated by inversion-translation-inversion. -/
  ...
  /-- The full closure acts on ambient projective null rays/states. -/
  ...
  /-- Full reflection-sensitive TKK/Möbius group-closure certificate. -/
