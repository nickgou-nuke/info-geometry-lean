...
theorem canonical_cover_chain :
  ...
  norm_num [Covers, pleromaPuncture, primalPolarity, mirrorEquator,
    relativisticQuadric, curvatureShadow, thermodynamicSplit, jordanAlchemy,
    indefiniteHorizon, trilinearEngine, paraQuaternionEngine, twistedReturn,
    arithmeticApotheosis]
