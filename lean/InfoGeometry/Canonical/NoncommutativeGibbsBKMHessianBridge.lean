...
open InfoGeometry.Canonical.NoncommutativeGibbsSecondDerivativeCenteredBridge
...
theorem complexGibbsHessianResponse_re_eq_centeredFrechetResponse
  ...
  have hZ0 : gibbsPartitionReal H ≠ 0 := ne_of_gt hZ
  rw [exponentialDerivative_complex_apply_eq_real H A]
  simp [normalizedFrechetTwoPoint, expectationReal, Complex.mul_re, hAim, hZ0]
