...
theorem creationQuadratic_isGammaEven (i j : Fin 5) :
  ...
  change gammaChiral * creation i = -(creation i * gammaChiral) at hi
  change gammaChiral * creation j = -(creation j * gammaChiral) at hj
  calc
...
theorem annihilationQuadratic_isGammaEven (i j : Fin 5) :
  ...
  change gammaChiral * annihilation i = -(annihilation i * gammaChiral) at hi
  change gammaChiral * annihilation j = -(annihilation j * gammaChiral) at hj
  calc
