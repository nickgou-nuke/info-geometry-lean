...
theorem reflection_sensitive :
    G.full_reflection_sensitive_group_closure_law :=
...
theorem positive_is_inversion_conjugate :
    G.positive_grade_is_inversion_conjugate_law :=
