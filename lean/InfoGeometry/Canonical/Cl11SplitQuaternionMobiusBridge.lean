...
def splitL : SplitQuaternion := InfoGeometryCore.sigma1R
...
theorem splitI_splitL_commutator :
  ...
  fin_cases i <;> fin_cases j <;>
    norm_num [splitIL, splitI, splitL, epsilon, InfoGeometryCore.sigma1R,
...
theorem splitLieH_splitLieE_commutator :
  ...
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [splitLieH, splitLieE, splitIL, splitI, splitL, epsilon, InfoGeometryCore.sigma1R,
      InfoGeometryCore.sigma1R, InfoGeometryCore.sigma3R,
      Matrix.mul_apply, Fin.sum_univ_two]
...
theorem splitLieH_splitLieF_commutator :
  ...
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [splitLieH, splitLieF, splitIL, splitI, splitL, epsilon, InfoGeometryCore.sigma1R,
      InfoGeometryCore.sigma1R, InfoGeometryCore.sigma3R,
      Matrix.mul_apply, Fin.sum_univ_two]
...
theorem splitLieE_splitLieF_commutator :
  ...
  fin_cases i <;> fin_cases j <;>
    norm_num [splitLieH, splitLieE, splitLieF, splitIL, splitI, splitL,
      epsilon, InfoGeometryCore.sigma1R, InfoGeometryCore.sigma1R, InfoGeometryCore.sigma3R,
      Matrix.mul_apply, Fin.sum_univ_two]
...
theorem splitIL_eq_sigma3 : splitIL = InfoGeometryCore.sigma3R := by
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [splitIL, splitI, splitL, epsilon, InfoGeometryCore.sigma1R,
      InfoGeometryCore.sigma1R, InfoGeometryCore.sigma3R,
...
theorem splitIL_sq : splitIL * splitIL = splitOne := by
  ...
  ext i j
  fin_cases i <;> fin_cases j <;>
    norm_num [splitOne, I2, InfoGeometryCore.sigma3R, InfoGeometryCore.sigma3R,
      Matrix.mul_apply, Fin.sum_univ_two]
...
theorem splitNull_ne_zero : splitNull ≠ 0 := by
  ...
  norm_num [splitNull, splitL, splitI, InfoGeometryCore.sigma1R, InfoGeometryCore.sigma1R,
    epsilon] at hentry
...
theorem splitNull_trace_zero : splitTrace splitNull = 0 := by
  norm_num [splitTrace, splitNull, splitL, splitI, InfoGeometryCore.sigma1R,
    InfoGeometryCore.sigma1R, epsilon]

theorem splitNull_det_zero : splitNull.det = 0 := by
  norm_num [splitNull, splitL, splitI, InfoGeometryCore.sigma1R,
...
theorem splitNull_stabilizer_coordinate_iff
  ...
  · intro h
    ...
    norm_num [splitNull, splitL, splitI, InfoGeometryCore.sigma1R, epsilon,
