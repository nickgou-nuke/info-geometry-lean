...
theorem transverseVector_dot_reflected (P : PauliVector) :
...
def pauliZorn (P : PauliVector) : InfoGeometry.Algebra.ZornMatrix ℝ where
  a := P.energy + P.pz
...
theorem zornNorm_pauliZorn (P : PauliVector) :
...
readout. -/
theorem circularWittQuadratic_pauli (P : PauliVector) :
...
theorem pauliMatrix_det_eq_zornNorm (P : PauliVector) :
...
readout. -/
theorem pauliMatrix_det_eq_circularWittQuadratic (P : PauliVector) :
    Matrix.det P.pauliMatrix =
      (circularWittQuadratic
...
theorem bipolar_pauli_zorn_witt_packet
    ...
    ZornMatrix.zornNorm (pauliZorn P) = P.minkowskiNormSq ∧
      circularWittQuadratic
        ...
        P.minkowskiNormSq ∧
      Matrix.det (bipolarSolderingAction s (pauliHermitian P)).mat =
        (ZornMatrix.zornNorm (pauliZorn P) : ℂ) ∧
      Matrix.det (bipolarSolderingAction s (pauliHermitian P)).mat =
        (circularWittQuadratic
          (minkowskiDiagonalEmbedding (pauliMomentumCoordinates P)) : ℂ) := by
