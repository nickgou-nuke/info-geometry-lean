...
def main() -> None:
    ...
    if args.host is None:
        args.host = os.getenv("ARANGO_URL") or os.getenv("ARANGO_ENDPOINT") or os.getenv("ARANGO_HOST") or "http://127.0.0.1:8530"
    ...
    if args.database is None:
        args.database = os.getenv("ARANGO_DATABASE") or os.getenv("ARANGO_DB") or "infogeometry"
